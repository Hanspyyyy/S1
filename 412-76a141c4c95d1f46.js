...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[412], {
    5481: function(t, e, i) {
        ...
        var s = i(7294)
          , o = i(4372);
        let n = t => "object" == typeof t && null !== t;
        function a(t, e, i= () => !1) {
            if (!n(t) || !n(e))
                return t === e;
            let s = Object.keys(t).filter(t => !i(t))
              , o = Object.keys(e).filter(t => !i(t));
        ...
        class l extends s.Component {
            ...
            shouldComponentUpdate(t) {
                ...
                return t.url !== this.props.url || t.id !== this.props.id || t.canvasClassName !== this.props.canvasClassName || t.className !== this.props.className || t.height !== this.props.height || t.width !== this.props.width || !a(t.style, this.props.style) || t.init !== this.props.init || t.loaded !== this.props.loaded || !a(e, i, t => t.startsWith("_"))
            }
            componentDidUpdate() {
                this.refresh()
            }
            ...
            componentDidMount() {
                (async () => {
                    this.props.init && await this.props.init(o.S6),
                    this.setState({
                        init: !0
                    }, async () => {
            ...
            render() {
                let {width: t, height: e, className: i, canvasClassName: o, id: n} = this.props;
    ...
    1495: function(t, e, i) {
        ...
        class a extends s.e {
            ...
            contains(t) {
                return (0,
                n.Sp)(t, this.position) <= this.radius
            }
            intersects(t) {
                let e = this.position
                  , i = t.position
                  ...
                  , n = this.radius;
                if (t instanceof a)
                    return n + t.radius > Math.sqrt(s.x ** 2 + s.y ** 2);
                if (t instanceof o.A) {
    ...
    6323: function(t, e, i) {
        ...
        class n extends o.e {
            ...
            intersects(t) {
                t instanceof s.C && t.intersects(this);
                let e = this.size.width
                  , i = this.size.height
                  , o = this.position
                  , a = t.position
                  , r = t instanceof n ? t.size : {
                    width: 0,
                    height: 0
                }
                  , l = r.width
                  , c = r.height;
                return a.x < o.x + e && a.x + l > o.x && a.y < o.y + i && a.y + c > o.y
            }
        }
    },
    8850: function(t, e, i) {
        ...
        class n {
            constructor(t, e, i) {
                ...
                o.hj)(t) && t)
                    ...
                    throw Error(`${s.gK} Vector3d not initialized correctly`)
            }
            static get origin() {
            ...
            add(t) {
                return n.create(this.x + t.x, this.y + t.y, this.z + t.z)
            }
            addTo(t) {
                this.x += t.x,
                this.y += t.y,
            ...
            rotate(t) {
                return n.create(this.x * Math.cos(t) - this.y * Math.sin(t), this.x * Math.sin(t) + this.y * Math.cos(t), 0)
            }
            setTo(t) {
                this.x = t.x,
                this.y = t.y,
    ...
    1588: function(t, e, i) {
        ...
        class a {
            ...
            load(t) {
                t && ((0,
                o.jn)(t.random) ? this.random.enable = t.random : this.random.load(t.random),
                void 0 !== t.value && (this.value = (0,
                n.Cs)(t.value, this.random.enable ? this.random.minimumValue : void 0)))
            }
        }
    },
    4133: function(t, e, i) {
        ...
        function c(t) {
            let {container: e, context: i, particle: o, delta: n, colorStyles: a, backgroundMask: r, composite: l, radius: c, opacity: h, shadow: d, transform: u} = t
              , p = o.getPosition()
    ...
    4808: function(t, e, i) {
        ...
        function g(t, e, i) {
                ...
                return i;
            {
                ...
                if (i && s && e)
                    return m(i, s, t.getRadius(), e.getRadius());
                {
                    let t = i ?? s;
                    if (t)
                        return u(t)
    ...
    2322: function(t, e, i) {
        ...
        function m(t) {
            ...
            return i ? p(y(t.value, o)) : p(t.value)
        }
        function g(t, e) {
            let i = t.x - e.x
              , s = t.y - e.y;
        ...
        function _(t, e, i, s) {
            return o.O.create(t.x * (i - s) / (i + s) + 2 * e.x * s / (i + s), t.y)
        }
        function k(t) {
            return {
                x: (t.position?.x ?? 100 * c()) * t.size.width / 100,
                y: (t.position?.y ?? 100 * c()) * t.size.height / 100
            }
        }
        function C(t) {
            let e = {
                x: t.position?.x !== void 0 ? p(t.position.x) : void 0,
                y: t.position?.y !== void 0 ? p(t.position.y) : void 0
            };
            return k({
                size: t.size,
                position: e
    ...
    4570: function(t, e, i) {
        ...
        class y {
            ...
            load(t) {
                ...
                s.ZB)(this.options, t.options)))
            }
        }
        var m = i(1968);
        class g {
            load(t) {
                t && (void 0 !== t.color && (this.color = m.O.create(this.color, t.color)),
        ...
        class _ {
            ...
            load(t) {
                ...
                void 0 !== e && ((0,
                s.Kn)(e) ? this.outModes.load(e) : this.outModes.load({
                    default: e
                })),
        ...
        class M extends r.SW {
            ...
            load(t) {
                ...
                this.value = (0,
                h.Cs)(this.value, this.animation.enable ? this.animation.minimumValue : void 0))
            }
        }
        class P {
            constructor() {
        ...
        class B {
            constructor() {
                this.loadShape = (t, e, i, o) => {
                    ...
                    s.kJ)(this.options[i]);
                    r && (this.options[e] = a),
                    l && o && (this.options[i] = a),
                    this.options[e] = (0,
                    s.ZB)(this.options[e] ?? a, t),
                    (!this.options[i] || o) && (this.options[i] = (0,
                    s.ZB)(this.options[i] ?? a, t))
                }
                ,
                this.close = !0,
                this.fill = !0,
            ...
            get character() {
                return this.options[D] ?? this.options[T]
            }
            set character(t) {
                this.options[T] = this.options[D] = t
            }
            get custom() {
                return this.options
            }
            ...
            get image() {
                return this.options[R] ?? this.options[I]
            }
            set image(t) {
            ...
            get polygon() {
                return this.options[E] ?? this.options[A]
            }
            set polygon(t) {
                this.options[A] = this.options[E] = t
            }
            get stroke() {
                return []
            }
            ...
            load(t) {
                ...
                if (void 0 !== e)
                    for (let t in e) {
                        let i = e[t];
                        i && (this.options[t] = (0,
                        s.ZB)(this.options[t] ?? {}, i))
                    }
                this.loadShape(t.character, D, T, !0),
                this.loadShape(t.polygon, E, A, !1),
                this.loadShape(t.image ?? t.images, R, I, !0),
        ...
        class q {
            ...
            load(t) {
                t && (void 0 !== t.color && (this.color = o.R.create(this.color, t.color)),
        ...
        class H {
            ...
            load(t) {
                ...
                this.color.load(o.R.create(this.color, t.color)),
                void 0 !== t.groups)
                    for (let e in t.groups) {
                        let i = t.groups[e];
                        void 0 !== i && (this.groups[e] = (0,
                        s.ZB)(this.groups[e] ?? {}, i))
                    }
    ...
    3248: function(t, e, i) {
            ...
            ZB: function() {
                return function t(e, ...i) {
                    for (let s of i) {
                        ...
                        for (let o in i && (E(e) || !e || !Array.isArray(e)) ? e = [] : !i && (E(e) || !e || Array.isArray(e)) && (e = {}),
                        s) {
                            if ("__proto__" === o)
                                continue;
                            let i = s[o]
                              , n = e;
                            n[o] = E(i) && Array.isArray(i) ? i.map(e => t(n[o], e)) : t(n[o], i)
                        }
                    }
                    return e
                }
        ...
        function f(t, e, i=!0) {
            return t[void 0 !== e && i ? e % t.length : p(t)]
        }
        function v(t, e, i, s, o) {
            ...
            return n = y(t, s ?? 0),
            a = !0,
            o && "bottom" !== o || (a = n.top < e.height + i.x),
            a && (!o || "left" === o) && (a = n.right > i.x),
            a && (!o || "right" === o) && (a = n.left < e.width + i.y),
            a && (!o || "top" === o) && (a = n.bottom > i.y),
            a
        }
        function y(t, e) {
            return {
        ...
        function m(t, e) {
            return !!z(e, e => e.enable && d(t, e.mode))
        }
        function g(t, e, i) {
            k(e, e => {
                let s = e.mode;
                e.enable && d(t, s) && k(e.selectors, t => {
                    i(t, e)
                }
                )
            }
        ...
        function b(t, e) {
            if (e && t)
                return z(t, t => (function(t, e) {
                    let i = k(e, e => t.matches(e));
                    return A(i) ? i.some(t => t) : i
                }
                )(e, t.selectors))
        }
        function w(t) {
            return {
                ...
                velocity: t.velocity,
                factor: o.O.create((0,
                s.NA)(t.options.bounce.horizontal), (0,
                s.NA)(t.options.bounce.vertical))
            }
        }
        function x(t, e) {
            let {x: i, y: o} = t.velocity.sub(e.velocity)
        ...
        function _(t, e) {
            let i = y(t.getPosition(), t.getRadius())
              , o = r({
                ...
                factor: (0,
                s.NA)(t.options.bounce.horizontal)
            });
        ...
        function k(t, e) {
            return A(t) ? t.map( (t, i) => e(t, i)) : e(t, 0)
        }
        function C(t, e, i) {
            return A(t) ? f(t, e, i) : t
        }
        function z(t, e) {
            return A(t) ? t.find( (t, i) => e(t, i)) : e(t, 0) ? t : void 0
        }
        function M(t, e) {
            let i = t.value
              , o = t.animation
            ...
            if (o.enable) {
                ...
                case "random":
                    n.status = (0,
                    s.sZ)() >= .5 ? "increasing" : "decreasing"
                }
                let t = "auto" === o.mode;
                switch (o.startValue) {
                case "min":
                    n.value = n.min,
                    t && (n.status = "increasing");
                    break;
                case "max":
                    n.value = n.max,
                    t && (n.status = "decreasing");
                    break;
                default:
                    n.value = (0,
                    s.vd)(n),
    ...
    4372: function(t, e, i) {
        ...
        class r {
            constructor(t) {
                ...
                this._getPluginParticleColors = t => {
                    ...
                    for (let s of this._colorPlugins)
                        ...
                        a.lN)(s.particleFillColor(t))),
                        !i && s.particleStrokeColor && (i = (0,
                        a.lN)(s.particleStrokeColor(t))),
                        e && i)
                            break;
                    return [e, i]
                }
            ...
            clear() {
                ...
                a.iz)(i.color, i.opacity)) : i.image && this._paintImage(i.image, i.opacity) : this.draw(t => {
                    (0,
                    n.ZH)(t, this.size)
                }
                )
            ...
            loadCanvas(t) {
                ...
                this._generated = t.dataset && s.YU in t.dataset ? "true" === t.dataset[s.YU] : this._generated,
                this.element = t,
                this.element.ariaHidden = "true",
                this._originalStyle = (0,
                o.ZB)({}, this.element.style),
        ...
        function l(t, e, i, s, n) {
            if (s) {
                ...
                (0,
                o.jn)(n) ? s.capture = n : void 0 !== n && (s = n),
            ...
            constructor(t) {
                ...
                this._doMouseTouchClick = t => {
                    ...
                    if (this._canPush) {
                        ...
                        (0,
                        o.KH)(n.mode, t => this.container.handleClickMode(t))
                    }
                ...
                this._handleThemeChange = t => {
                    ...
                    n && n.default.auto && e.loadTheme(o)
                }
                ,
                ...
                this._manageInteractivityListeners = (t, e) => {
                    ...
                    if (!a)
                        return;
                    let r = o.canvas.element;
                    r && (r.style.pointerEvents = a === r ? "initial" : "none"),
                    (n.interactivity.events.onHover.enable || n.interactivity.events.onClick.enable) && (l(a, s.Wt, i.mouseMove, e),
                    l(a, s.Re, i.touchStart, e),
                    l(a, s.zX, i.touchMove, e),
                    n.interactivity.events.onClick.enable ? (l(a, s.$o, i.touchEndClick, e),
                    l(a, s.zw, i.mouseUp, e),
                    l(a, s.ZL, i.mouseDown, e)) : l(a, s.$o, i.touchEnd, e),
                    l(a, t, i.mouseLeave, e),
                    l(a, s.VH, i.touchCancel, e))
                }
                ,
                this._manageListeners = t => {
                    ...
                    a = s.G1) : "parent" === o && n ? i.interactivity.element = n.parentElement ?? n.parentNode : i.interactivity.element = n,
                    this._manageMediaMatch(t),
                    this._manageResize(t),
                    this._manageInteractivityListeners(a, t),
                    document && l(document, s.QL, e.visibilityChange, t, !1)
                }
                ,
                this._manageMediaMatch = t => {
                    let e = this._handlers
                      , i = (0,
                    o.HY)("(prefers-color-scheme: dark)");
                    if (i) {
                ...
                this._manageResize = t => {
                    ...
                    if ("undefined" == typeof ResizeObserver) {
                        l(window, s.rR, e.resize, t);
                        return
                    }
                    let o = i.canvas.element;
                    this._resizeObserver && !t ? (o && this._resizeObserver.unobserve(o),
                    this._resizeObserver.disconnect(),
                    delete this._resizeObserver) : !this._resizeObserver && t && o && (this._resizeObserver = new ResizeObserver(async t => {
                        t.find(t => t.target === o) && await this._handleWindowResize()
                    }
                    ),
                    ...
                    t.type.startsWith("pointer")) {
                        ...
                        n.element === window) {
                            ...
                            if (i && s && a) {
                                ...
                                e = {
                                    x: t.offsetX + 2 * o.left - (n.left + r.left),
                                    y: t.offsetY + 2 * o.top - (n.top + r.top)
                                }
                            } else
                                e = {
        ...
        class y {
            ...
            get ids() {
                return (0,
                o.KH)(this.selectors, t => t.replace("#", ""))
            }
            set ids(t) {
                this.selectors = (0,
                o.KH)(t, t => `#${t}`)
        ...
        class w {
            ...
            load(t) {
                ...
                (0,
                o.jn)(t.resize) ? this.resize.enable = t.resize : this.resize.load(t.resize)
            }
        }
        class x {
            constructor(t, e) {
        ...
        class S {
            constructor(t, e) {
                ...
                this.particles = (0,
                P.x)(this._engine, this._container),
                this.pauseOnBlur = !0,
            ...
            load(t) {
                if (!t)
                    return;
                void 0 !== t.preset && (0,
                o.KH)(t.preset, t => this._importPreset(t)),
                ...
                (0,
                o.jn)(s) ? this.fullScreen.enable = s : this.fullScreen.load(s),
        ...
        class E {
            constructor(t, e, i, a, r, l) {
                ...
                this._calcPosition = (t, e, i, s=0) => {
                    ...
                    this._checkOverlap(a, s)) ? this._calcPosition(t, void 0, i, s + 1) : a
                }
                ,
                this._calculateVelocity = () => {
                    let t = (0,
                    O.lQ)(this.direction).copy()
                      , e = this.options.move;
                ...
                this._checkOverlap = (t, e=0) => {
                    ...
                    let a = n.retries;
                    if (a >= 0 && e > a)
                        throw Error(`${s.gK} particle is overlapping and can't be placed`);
                    return !!this.container.particles.find(e => (0,
                    O.Sp)(t, e.position) < o + e.getRadius())
                }
                ,
                this._getRollColor = t => {
                    ...
                    n.PL)(t, this.roll.alter.type, this.roll.alter.value) : t : t
                }
                ,
                this._initPosition = t => {
                    let e = this.container
                      , i = (0,
                    O.Gu)(this.options.zIndex.value);
                    ...
                    switch (this.moveCenter = {
                        ...(0,
                        o.bt)(this.options.move.center, s),
                        radius: this.options.move.center.radius ?? 0,
                        mode: this.options.move.center.mode ?? "percent"
                    },
                    this.direction = (0,
                    O.Gk)(this.options.move.direction, this.position, this.moveCenter),
            ...
            init(t, e, i, s) {
                ...
                let l = n.retina.pixelRatio
                  , c = n.actualOptions
                  , h = (0,
                P.x)(this._engine, n, c.particles)
                  , d = h.shape.type
                ...
                let v = new _(r,n);
                v.load(n.actualOptions.interactivity),
                ...
                this.pathGenerator && n.addPath(y.generator, this.pathGenerator) && this.pathGenerator.init(n)),
                n.retina.initParticle(this),
                this.size = (0,
                o.V0)(this.options.size, l),
                this.bubble = {
                    inRange: !1
                },
                this.slow = {
                ...
                !g && (g = this._engine.plugins.getShapeDrawer(this.shape)) && n.drawers.set(this.shape, g),
                g && g.loadShape && g.loadShape(this);
                let b = g?.getSidesCount;
                for (let t of (b && (this.sides = b(this)),
                this.spawning = !1,
                this.shadowColor = (0,
                a.tX)(this.options.shadow.color),
                n.particles.updaters))
                    t.init(this);
                for (let t of n.particles.movers)
                    t.init && t.init(this);
                for (let[,t] of (g && g.particleInit && g.particleInit(n, this),
                n.plugins))
        ...
        class G {
            constructor(t, e) {
                ...
                this._subdivide = () => {
                    let {x: t, y: e} = this.rectangle.position
                      ...
                      , {capacity: o} = this;
                    for (let n = 0; n < 4; n++)
                        this._subs.push(new G(new L.A(t + i / 2 * (n % 2),e + s / 2 * (Math.round(n / 2) - n % 2),i / 2,s / 2),o));
                    this._divided = !0
                }
                ,
                this._points = [],
            ...
            query(t, e, i) {
                ...
                for (let i of this._points)
                    ...
                    O.Sp)(t.position, i.position) > i.particle.getRadius() && (!e || e(i.particle)) || s.push(i.particle);
                if (this._divided)
            ...
            queryCircle(t, e, i) {
                return this.query(new B.C(t.x,t.y,e), i)
            }
            queryRectangle(t, e, i) {
                return this.query(new L.A(t.x,t.y,e.width,e.height), i)
            }
        }
        let q = t => new L.A(-t.width / 4,-t.height / 4,3 * t.width / 2,3 * t.height / 2);
        class F {
            constructor(t, e) {
                ...
                ,
                this._pushParticle = (t, e, i, n) => {
                    try {
                        let s = this.pool.pop();
                        s ? s.init(this._nextId, t, e, i) : s = new E(this._engine,this._nextId,this._container,t,e,i);
                        let o = !0;
                        if (n && (o = n(s)),
                        !o)
                            return;
                        ...
                        (0,
                        o.jl)().warning(`${s.gK} adding particle: ${t}`);
                        return
                    }
                }
                ,
            ...
            addManualParticles() {
                ...
                for (let e of t.actualOptions.manualParticles)
                    ...
                    o.bt)(e.position, t.canvas.size) : void 0, e.options)
            }
            addParticle(t, e, i, s) {
            ...
            async update(t) {
                let e = this._container
                  , i = new Set;
                for (let[,t] of (this.quadTree = new G(q(e.canvas.size),4),
                e.pathGenerators))
                    t.update();
                for (let[,i] of e.plugins)
                    i.update && i.update(t);
                for (let s of this._array) {
                    let o = e.canvas.resizeFactor;
                    for (let[,e] of (o && !s.ignoresResizeRatio && (s.position.x *= o.width,
                    ...
                    this.quadTree.insert(new A(s.getPosition(),s))
                }
                if (i.size) {
                    let t = t => !i.has(t);
        ...
        class H {
            ...
            init() {
                ...
                o.Kr)() ? 1 : window.devicePixelRatio,
                this.reduceFactor = 1;
                ...
                O.Gu)(n.attract.distance) * i,
                this.maxSpeed = (0,
                O.Gu)(n.gravity.maxSpeed) * i,
                this.sizeAnimationSpeed = (0,
                O.Gu)(s.size.animation.speed) * i
            }
            initParticle(t) {
                let e = t.options
                  , i = this.pixelRatio
        ...
        class U {
            constructor(t, e, i) {
                ...
                this._intersectionManager = t => {
                    if (W(this) && this.actualOptions.pauseOnOutsideViewport)
                        for (let e of t)
                ...
                this._nextFrame = async t => {
                    try {
                        ...
                        (0,
                        o.jl)().error(`${s.gK} in animation loop`, t)
                    }
                }
                ,
                this._engine = t,
                ...
                this.retina = new H(this),
                this.canvas = new r(this),
                this.particles = new F(this._engine,this),
                ...
                this._options = Z(this._engine, this),
                this.actualOptions = Z(this._engine, this),
            ...
            addPath(t, e, i=!1) {
                return !(!W(this) || !i && this.pathGenerators.has(t)) && (this.pathGenerators.set(t, e ?? V),
                !0)
            }
            alive() {
            ...
            async export(t, e={}) {
                ...
                (0,
                o.jl)().error(`${s.gK} - Export plugin with type ${t} not found`)
            }
            getAnimationStatus() {
                return !this._paused && !this.pageHidden && W(this)
            }
            handleClickMode(t) {
                if (W(this))
            ...
            async init() {
                if (W(this)) {
                    ...
                    for (let[t,e] of (this._options = Z(this._engine, this, this._initialSourceOptions, this.sourceOptions),
                    this.actualOptions = Z(this._engine, this, this._options),
                    ...
                    O.Gu)(this.actualOptions.duration),
                    this._delay = 1e3 * (0,
                    O.Gu)(this.actualOptions.delay),
                    this._lifeTime = 0,
            ...
            async loadTheme(t) {
                W(this) && (this._currentTheme = t,
                await this.refresh())
            }
            pause() {
                if (W(this) && (void 0 !== this._drawAnimationFrame && (cancelAnimationFrame(this._drawAnimationFrame),
            ...
            async start() {
                W(this) && !this.started && (await this.init(),
                this.started = !0,
                await new Promise(t => {
        ...
        class $ {
            ...
            getInteractors(t, e=!1) {
                return K(t, this.interactors, this._initializers.interactors, e)
            }
            getMovers(t, e=!1) {
                return K(t, this.movers, this._initializers.movers, e)
            }
            getPathGenerator(t) {
            ...
            getUpdaters(t, e=!1) {
                return K(t, this.updaters, this._initializers.updaters, e)
            }
            loadOptions(t, e) {
                for (let i of this.plugins)
                    i.loadOptions(t, e)
        ...
        async function N(t) {
            ...
            o.jl)().error(`${s.gK} ${i.status} while retrieving config file`),
            t.fallback)
        }
        class X {
            constructor() {
            ...
            async loadFromArray(t, e, i) {
                ...
                (0,
                o.HD)(t) ? s.id = t : s.options = t,
                (0,
                o.hj)(e) ? s.index = e : s.options = e ?? s.options,
                s.index = i ?? s.index),
                this._loadParams(s)
            }
            ...
            async set(t, e, i, s) {
                ...
                return (0,
                o.HD)(t) ? n.id = t : n.element = t,
                e instanceof HTMLElement ? n.element = e : n.options = e,
                (0,
                o.hj)(i) ? n.index = i : n.options = i ?? n.options,
                this._loadParams(n)
            }
            ...
            setOnClickHandler(t) {
                let e = this.dom();
                if (!e.length)
                    throw Error(`${s.gK} can only set click handlers after calling tsParticles.load()`);
                for (let i of e)
                    i.addClickHandler(t)
            }
            async _loadParams(t) {
                let e;
                let i = t.id ?? `tsparticles${Math.floor(1e4 * (0,
                O.sZ)())}`
                  , {index: n, url: a} = t
                  , r = a ? await N({
                    fallback: t.options,
                ...
                if ("canvas" === l.tagName.toLowerCase())
                    (e = l).dataset[s.YU] = "false";
                else {
                    let t = l.getElementsByTagName("canvas");
                    t.length ? (e = t[0]).dataset[s.YU] = "false" : ((e = document.createElement("canvas")).dataset[s.YU] = "true",
                    l.appendChild(e))
                }
                e.style.width || (e.style.width = "100%"),
                e.style.height || (e.style.height = "100%");
                let u = new U(this,i,c);
    ...
    7918: function(t, e, i) {
        ...
        class l extends a.SW {
            ...
            load(t) {
                ...
                (0,
                s.hj)(t.limit) ? this.limit.radius = t.limit : this.limit.load(t.limit))
            }
        }
        class c {
            constructor() {
            ...
            load(t) {
                void 0 !== t && (void 0 !== t.color && (this.color = o.O.create(this.color, t.color)),
                void 0 !== t.draggable && (this.draggable = t.draggable),
                this.name = t.name,
                void 0 !== t.opacity && (this.opacity = t.opacity),
                void 0 !== t.position && (this.position = {},
                void 0 !== t.position.x && (this.position.x = (0,
                n.Cs)(t.position.x)),
                void 0 !== t.position.y && (this.position.y = (0,
                n.Cs)(t.position.y))),
        ...
        class u {
            constructor(t, e, i, s) {
                ...
                this._updateParticlePosition = (t, e) => {
                    ...
                    if (this.options.orbits) {
                        if (void 0 === t.absorberOrbit && (t.absorberOrbit = h.O.create(0, 0),
                        t.absorberOrbit.length = (0,
                        n.Sp)(t.getPosition(), this.position),
                        t.absorberOrbit.angle = (0,
                        n.sZ)() * Math.PI * 2),
                        t.absorberOrbit.length <= this.size && !this.options.destroy) {
                            let e = Math.min(s.width, s.height);
                            t.absorberOrbit.length = e * (1 + (.2 * (0,
                            n.sZ)() - .1))
                        }
                        ...
                        t.velocity.setTo(h.O.origin);
                        let l = {
                            x: "clockwise" === r ? Math.cos : Math.sin,
                            y: "clockwise" === r ? Math.sin : Math.cos
                        };
                        t.position.x = this.position.x + o * l.x(a),
                        t.position.y = this.position.y + o * l.y(a),
                        t.absorberOrbit.length -= e.length,
                        t.absorberOrbit.angle += (t.retina.moveSpeed ?? 0) * i.retina.pixelRatio / 100 * i.retina.reduceFactor
                    } else {
                        let i = h.O.origin;
                        i.length = e.length,
                        i.angle = e.angle,
                ...
                ,
                this.initialPosition = s ? h.O.create(s.x, s.y) : void 0,
                i instanceof c ? this.options = i : (this.options = new c,
                this.options.load(i)),
                this.dragging = !1,
                this.name = this.options.name,
                this.opacity = this.options.opacity,
                this.size = (0,
                n.Gu)(this.options.size.value) * e.retina.pixelRatio,
            ...
            attract(t) {
                ...
                if (i.draggable) {
                    let t = e.interactivity.mouse;
                    t.clicking && t.downPosition ? (0,
                    n.Sp)(this.position, t.downPosition) <= this.size && (this.dragging = !0) : this.dragging = !1,
                    this.dragging && t.position && (this.position.x = t.position.x,
                    this.position.y = t.position.y)
                }
                let s = t.getPosition()
                  , {dx: o, dy: a, distance: r} = (0,
                n.oW)(this.position, s)
                  , l = h.O.create(o, a);
                if (l.length = this.mass / Math.pow(r, 2) * e.retina.reduceFactor,
                r < this.size + t.getRadius()) {
                    let s = .033 * t.getRadius() * e.retina.pixelRatio;
                    this.size > t.getRadius() && r < this.size - t.getRadius() || void 0 !== t.absorberOrbit && t.absorberOrbit.length < 0 ? i.destroy ? t.destroy() : (t.needsNewPosition = !0,
                    this._updateParticlePosition(t, l)) : (i.destroy && (t.size.value -= s),
            ...
            draw(t) {
                ...
                t.closePath(),
                t.fillStyle = (0,
                d.iz)(this.color, this.opacity),
                t.fill()
            }
            resize() {
                let t = this.initialPosition;
                this.position = t && (0,
                s.Ac)(t, this.container.canvas.size, h.O.origin) ? t : this._calcPosition()
            }
        }
        class p {
            constructor(t) {
                ...
                t.getAbsorber = t => void 0 === t || (0,
                s.hj)(t) ? this.array[t || 0] : this.array.find(e => e.name === t),
                t.addAbsorber = (t, e) => this.addAbsorber(t, e)
            }
            addAbsorber(t, e) {
                let i = new u(this,this.container,t,e);
        ...
        class f {
            ...
            loadOptions(t, e) {
                (this.needsPlugin(t) || this.needsPlugin(e)) && (e?.absorbers && (t.absorbers = (0,
                s.KH)(e.absorbers, t => {
                    let e = new c;
                    return e.load(t),
                    e
                ...
                t.interactivity.modes.absorbers = (0,
                s.KH)(e?.interactivity?.modes?.absorbers, t => {
                    let e = new c;
                    return e.load(t),
                    e
                }
            ...
            needsPlugin(t) {
                ...
                let e = t.absorbers;
                return (0,
                s.kJ)(e) ? !!e.length : !!(e || t.interactivity?.events?.onClick?.mode && (0,
                s.dB)("absorber", t.interactivity.events.onClick.mode))
            }
        }
        async function v(t, e=!0) {
            await t.addPlugin(new f, e)
        }
        class y {
            load(t) {
                t && (void 0 !== t.bottom && (this.bottom = (0,
                n.Cs)(t.bottom)),
                void 0 !== t.left && (this.left = (0,
                n.Cs)(t.left)),
                void 0 !== t.right && (this.right = (0,
                n.Cs)(t.right)),
                void 0 !== t.top && (this.top = (0,
                n.Cs)(t.top)))
            }
        }
        class m extends a.SW {
            constructor() {
                super(),
                this.value = 3
            }
        }
        class g extends a.SW {
            constructor() {
                super(),
                this.value = {
                    min: 4,
        ...
        class _ {
            ...
            init(t) {
                ...
                let {bottom: o, left: a, right: r, top: l} = s
                  , {destroyBounds: c} = t
                  , h = e.canvas.size;
                o && (c.bottom = (0,
                n.Gu)(o) * h.height / 100),
            ...
            loadOptions(t, ...e) {
                for (let i of (t.destroy || (t.destroy = new w),
                e))
            ...
            particleDestroyed(t, e) {
                ...
                i && "split" === i.mode && function(t, e, i) {
                    let o = i.options.destroy;
                    if (!o)
                        return;
                    let a = o.split;
                    if (a.count >= 0 && (void 0 === i.splitCount || i.splitCount++ > a.count))
                        return;
                    let r = (0,
                    n.NA)(a.rate)
                      , l = (0,
                    ...
                    for (let o = 0; o < r; o++)
                        !function(t, e, i, o) {
                            ...
                            n.NA)(r.factor)
                              , h = i.getFillColor();
                            r.color ? l.color.load(r.color) : r.colorOffset && h ? l.color.load({
                                value: {
                                    hsl: {
                                        h: h.h + (0,
                                        n.Gu)(r.colorOffset.h ?? 0),
                                        s: h.s + (0,
                                        n.Gu)(r.colorOffset.s ?? 0),
                                        l: h.l + (0,
                                        n.Gu)(r.colorOffset.l ?? 0)
                                    }
                                }
                            }) : l.color.load({
                                value: {
                            ...
                            (0,
                            s.hj)(l.size.value) ? l.size.value /= c : (l.size.value.min /= c,
                            l.size.value.max /= c),
                            l.load(o);
                            let d = r.sizeOffset ? (0,
                            n.Cs)(-i.size.value, i.size.value) : 0
                              , u = {
                                x: i.position.x + (0,
                                n.vd)(d),
                                y: i.position.y + (0,
                            ...
                            e.particles.addParticle(u, l, i.group, t => !(t.size.value < .5) && (t.velocity.length = (0,
                            n.vd)((0,
                            n.Cs)(i.velocity.length, t.velocity.length)),
        ...
        class C {
            randomPosition(t, e, i) {
                let[s,o] = [e.width / 2, e.height / 2]
                  , a = ( (t, e) => {
                    let i = Math.atan(e / t * Math.tan(2 * Math.PI * ((0,
                    n.sZ)() / 4)))
                      , s = (0,
                    n.sZ)();
                    return s < .25 ? i : s < .5 ? Math.PI - i : s < .75 ? Math.PI + i : -i
                }
                )(s, o)
                  , r = s * o / Math.sqrt((o * Math.cos(a)) ** 2 + (s * Math.sin(a)) ** 2)
                  , l = i ? r * Math.sqrt((0,
                n.sZ)()) : r;
                return {
                    x: t.x + l * Math.cos(a),
        ...
        class S {
            ...
            load(t) {
                t && (void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay),
                void 0 !== t.size && (this.size || (this.size = new O),
                this.size.load(t.size)),
                void 0 !== t.direction && (this.direction = t.direction),
                this.domId = t.domId,
                void 0 !== t.fill && (this.fill = t.fill),
                ...
                void 0 !== t.position.y && (this.position.y = (0,
                n.Cs)(t.position.y))),
                void 0 !== t.spawnColor && (void 0 === this.spawnColor && (this.spawnColor = new z.R),
        ...
        class D {
            constructor(t, e, i, o, a) {
                ...
                this._emit = () => {
                    if (this._paused)
                        return;
                    let t = (0,
                    n.Gu)(this.options.rate.quantity);
                ...
                this._emitParticles = t => {
                    let e = this.getPosition()
                      , i = this.getSize()
                      , o = (0,
                    s.wA)(this._particlesOptions);
                    for (let n = 0; n < t; n++) {
                        let t = (0,
                        s.ZB)({}, o);
                        if (this.spawnColor) {
                            let e = this.options.spawnColor?.animation;
                            e && (this.spawnColor.h = this._setColorAnimation(e.h, this.spawnColor.h, 360),
                            this.spawnColor.s = this._setColorAnimation(e.s, this.spawnColor.s, 100),
                            this.spawnColor.l = this._setColorAnimation(e.l, this.spawnColor.l, 100)),
                        ...
                        if (!e)
                            return;
                        let n = this._shape?.randomPosition(e, i, this.fill) ?? e;
                        this.container.particles.addParticle(n, t)
                    }
                }
                ,
                this._prepareToDie = () => {
                    if (this._paused)
                        return;
                    let t = this.options.life?.duration !== void 0 ? (0,
                    n.Gu)(this.options.life.duration) : void 0;
                ...
                this._setColorAnimation = (t, e, i) => {
                    ...
                    n.vd)(t.offset)
                      , a = 1e3 * (0,
                    n.Gu)(this.options.rate.delay) / s.retina.reduceFactor;
                    return (e + (0,
                    n.Gu)(t.speed ?? 0) * s.fpsLimit / a + 3.6 * o) % i
                }
                ,
                this._engine = t,
                ...
                o instanceof S ? this.options = o : (this.options = new S,
                this.options.load(o)),
                this._spawnDelay = 1e3 * (0,
                n.Gu)(this.options.life.delay ?? 0) / this.container.retina.reduceFactor,
                ...
                let r = (0,
                s.ZB)({}, this.options.particles);
                r ??= {},
                r.move ??= {},
                r.move.direction ??= this.options.direction,
                this.options.spawnColor && (this.spawnColor = (0,
                d.lN)(this.options.spawnColor)),
            ...
            update(t) {
                !this._paused && (this._firstSpawn && (this._firstSpawn = !1,
                ...
                this._spawnDelay = 1e3 * (0,
                n.Gu)(this.options.life.delay ?? 0) / this.container.retina.reduceFactor) : this._destroy(),
        ...
        class T {
            ...
            addEmitter(t, e) {
                let i = new S;
                i.load(t);
                let s = new D(this._engine,this,this.container,i,e);
                ...
                s.kJ)(o.value)) {
                    if (o.value.length > 0 && o.random.enable) {
                        ...
                        for (let i = 0; i < o.random.count; i++) {
                            let n = (0,
                            s.dU)(o.value);
                            if (t.includes(n) && t.length < o.value.length) {
                                i--;
                                continue
                            }
                            t.push(n),
        ...
        class B {
            ...
            getPlugin(t) {
                return new T(this._engine,t)
            }
            loadOptions(t, e) {
                if (!this.needsPlugin(t) && !this.needsPlugin(e))
                    return;
                e?.emitters && (t.emitters = (0,
                s.KH)(e.emitters, t => {
                    let e = new S;
                    return e.load(t),
                    e
            ...
            needsPlugin(t) {
                ...
                let e = t.emitters;
                return (0,
                s.kJ)(e) && !!e.length || void 0 !== e || !!t.interactivity?.events?.onClick?.mode && (0,
                s.dB)("emitter", t.interactivity.events.onClick.mode)
            }
        }
        async function L(t, e=!0) {
            t.emitterShapeManager || (t.emitterShapeManager = new I(t)),
            ...
            t.addEmitterShape("circle", new C),
            t.addEmitterShape("square", new A)
        }
        class G {
            constructor(t) {
                this.container = t,
        ...
        class F extends G {
            ...
            async interact(t) {
                ...
                if (!s)
                    return;
                let o = 1e3 * s.delay / this.container.retina.reduceFactor;
            ...
            isEnabled(t) {
                ...
                return o.clicking && o.inside && !!o.position && (0,
                s.dB)("trail", n.onClick.mode) || o.inside && !!o.position && (0,
                s.dB)("trail", n.onHover.mode)
            }
            loadModeOptions(t, ...e) {
                for (let i of (t.trail || (t.trail = new q),
                e))
        ...
        async function H(t, e=!0) {
            await t.addInteractor("externalTrail", t => new F(t), e)
        }
        class W {
            constructor() {
                this.enable = !1,
        ...
        class Z {
            constructor() {
                this.darken = new W,
                this.enable = !1,
                this.enlighten = new W,
                this.mode = "vertical",
                this.speed = 25
            }
            load(t) {
                t && (void 0 !== t.backColor && (this.backColor = o.O.create(this.backColor, t.backColor)),
        ...
        class V {
            ...
            init(t) {
                !function(t) {
                    ...
                    e.backColor)
                        ...
                        let i = (0,
                        n.sZ)() >= .5 ? "darken" : "enlighten";
                        t.roll.alter = {
                            type: i,
                            value: (0,
                            n.Gu)("darken" === i ? e.darken.value : e.enlighten.value)
                        }
                    } else
            ...
            loadOptions(t, ...e) {
                for (let i of (t.roll || (t.roll = new Z),
                e))
                    t.roll.load(i?.roll)
            }
            update(t, e) {
        ...
        async function U(t, e=!0) {
            await t.addParticleUpdater("roll", () => new V, e)
        }
        var j = i(4372);
        class K {
            static init(t) {
                ...
                return j.S6.set(i.replace(".", "").replace("!", ""), s, {
                    fullScreen: {
                        enable: !1
                    },
                    particles: {
        ...
        class X {
            ...
            move(t, e) {
                ...
                let o = t.container
                  ...
                  , r = t.slow.inRange ? t.slow.factor : 1
                  , l = (t.retina.moveSpeed ??= (0,
                n.Gu)(s.speed) * a) * o.retina.reduceFactor
                  , c = t.retina.moveDrift ??= (0,
                n.Gu)(t.options.move.drift) * a
                  , h = (0,
                n.KI)(i.size.value) * a
                  , d = l * (s.size ? t.getRadius() / h : 1) * r * (e.factor || 1) / 2
                ...
                s.spin.enable ? function(t, e) {
                    ...
                    (function(t, e) {
                        ...
                        n.uZ)(t.velocity.x, -1, 1),
                        t.velocity.y = (0,
                        n.uZ)(t.velocity.y, -1, 1)),
                    ...
                    r?.enable && i && (t.velocity.y += r.acceleration * a.factor * l / (60 * i));
                    let c = t.moveDecay;
                    t.velocity.multTo(c);
                    let h = t.velocity.mult(i);
                    r?.enable && s > 0 && (!r.inverse && h.y >= 0 && h.y >= s || r.inverse && h.y <= 0 && h.y <= -s) && (h.y = l * s,
        ...
        function tt(t, e, i, s, o) {
            ...
            let a = (0,
            n.vd)(i.offset)
              , r = (e.velocity ?? 0) * t.factor + 3.6 * a
              , l = e.decay ?? 1;
            o && "increasing" !== e.status ? (e.value -= r,
            e.value < 0 && (e.loops || (e.loops = 0),
            e.loops++,
            e.status = "increasing",
            e.value += e.value)) : (e.value += r,
            e.value > s && (e.loops || (e.loops = 0),
            e.loops++,
            o && (e.status = "decreasing",
            e.value -= e.value % s))),
        ...
        class te {
            ...
            init(t) {
                let e = (0,
                d.lN)(t.options.color, t.id, t.options.reduceDuplicates);
                e && (t.color = (0,
                d.bS)(e, t.options.color.animation, this.container.retina.reduceFactor))
            }
            isEnabled(t) {
            ...
            update(t, e) {
                !function(t, e) {
                    let {h: i, s: s, l: o} = t.options.color.animation
                      , {color: n} = t;
                    if (!n)
                        return;
                    let {h: a, s: r, l} = n;
        ...
        async function ti(t, e=!0) {
            await t.addParticleUpdater("color", t => new te(t), e)
        }
        class ts {
            constructor(t) {
                this.container = t
            ...
            init(t) {
                ...
                n.Gu)(i.speed) / 100 * this.container.retina.reduceFactor,
        ...
        async function to(t, e=!0) {
            await t.addParticleUpdater("opacity", t => new ts(t), e)
        }
        class tn {
            constructor(t) {
                this.container = t,
            ...
            update(t, e, i, o) {
                ...
                let a = this.container
                  , r = !1;
                for (let[,s] of a.plugins)
                    if (void 0 !== s.particleBounce && (r = s.particleBounce(t, i, e)),
                    r)
                        break;
                if (r)
                    return;
                ...
                !function(t) {
                    ...
                    if ("right" === t.direction && t.bounds.right >= t.canvasSize.width && e > 0 || "left" === t.direction && t.bounds.left <= 0 && e < 0) {
                        let e = (0,
                        n.NA)(t.particle.options.bounce.horizontal);
                ...
                function(t) {
                    ...
                    if ("bottom" === t.direction && t.bounds.bottom >= t.canvasSize.height && e > 0 || "top" === t.direction && t.bounds.top <= 0 && e < 0) {
                        let e = (0,
                        n.NA)(t.particle.options.bounce.vertical);
        ...
        class ta {
            ...
            update(t, e, i, o) {
                ...
                case "outside":
                    if ((0,
                    s.Ac)(t.position, a.canvas.size, h.O.origin, t.getRadius(), e))
                        return;
                    break;
                case "inside":
                    {
                        let {dx: e, dy: i} = (0,
                        n.oW)(t.position, t.moveCenter)
                          , {x: s, y: o} = t.velocity;
        ...
        class tr {
            ...
            update(t, e, i, o) {
                if (!this.modes.includes(o) || t.options.move.distance.horizontal && ("left" === e || "right" === e) || t.options.move.distance.vertical && ("top" === e || "bottom" === e))
                    return;
                ...
                if (n.enable) {
                    ...
                    if (t.velocity.y > 0 && t.position.y <= r.height + l || t.velocity.y < 0 && t.position.y >= -l || t.velocity.x > 0 && t.position.x <= r.width + l || t.velocity.x < 0 && t.position.x >= -l)
                        return;
                    (0,
                    s.Ac)(t.position, a.canvas.size, h.O.origin, l, e) || a.particles.remove(t)
                }
            }
        }
        class tl {
            ...
            update(t, e, i, o) {
                ...
                if ("inside" === t.outType) {
                    ...
                    s.addTo(h.O.create(t.moveCenter));
                    let {dx: o, dy: r} = (0,
                    n.oW)(t.position, s);
                    if (e <= 0 && o >= 0 || i <= 0 && r >= 0 || e >= 0 && o <= 0 || i >= 0 && r <= 0)
                        return;
                    t.position.x = Math.floor((0,
                    n.vd)({
                        min: 0,
                        max: a.canvas.size.width
                    })),
                    t.position.y = Math.floor((0,
                    n.vd)({
                        min: 0,
                        max: a.canvas.size.height
                    }));
                    let {dx: l, dy: c} = (0,
                    n.oW)(t.position, t.moveCenter);
                    ...
                    case "normal":
                        {
                            let i = t.options.move.warp
                              ...
                              , c = (0,
                            s.M_)(t.position, l);
                            "right" === e && c.left > o.width + t.offset.x ? (t.position.x = r.left,
                            t.initialPosition.x = t.position.x,
                            i || (t.position.y = (0,
                            n.sZ)() * o.height,
                            t.initialPosition.y = t.position.y)) : "left" === e && c.right < -t.offset.x && (t.position.x = r.right,
                            t.initialPosition.x = t.position.x,
                            i || (t.position.y = (0,
                            n.sZ)() * o.height,
                            t.initialPosition.y = t.position.y)),
                            "bottom" === e && c.top > o.height + t.offset.y ? (i || (t.position.x = (0,
                            n.sZ)() * o.width,
                            t.initialPosition.x = t.position.x),
                            t.position.y = r.top,
                            t.initialPosition.y = t.position.y) : "top" === e && c.bottom < -t.offset.y && (i || (t.position.x = (0,
                            n.sZ)() * o.width,
                            t.initialPosition.x = t.position.x),
        ...
        class tc {
            constructor(t) {
                ...
                ,
                this.updaters = [new tn(t), new ta(t), new tl(t), new tr(t)]
            }
            init() {}
            isEnabled(t) {
        ...
        async function th(t, e=!0) {
            await t.addParticleUpdater("outModes", t => new tc(t), e)
        }
        class td {
            init(t) {
                let e = t.container
        ...
        async function tu(t, e=!0) {
            await t.addParticleUpdater("size", () => new td, e)
        }
        ...
        async function tf() {
            (0,
            n.bx)("ease-in-quad", t => t ** 2),
            (0,
            n.bx)("ease-out-quad", t => 1 - (1 - t) ** 2),
            (0,
            n.bx)("ease-in-out-quad", t => t < .5 ? 2 * t ** 2 : 1 - (-2 * t + 2) ** 2 / 2)
        }
        var tv = i(1495)
          , ty = i(9907);
        class tm {
        ...
        class tg extends G {
            constructor(t, e) {
                ...
                this._clickAttract = () => {
                    ...
                    e.clicking) {
                        ...
                        if (!i || i < 0 || !e)
                            return;
                        this._processAttract(e, i, new tv.C(e.x,e.y,i))
                    } else
                ...
                this._hoverAttract = () => {
                    let t = this.container
                      ...
                      , i = t.retina.attractModeDistance;
                    i && !(i < 0) && e && this._processAttract(e, i, new tv.C(e.x,e.y,i))
                }
                ,
                    ...
                    if (o)
                        for (let a of s.particles.quadTree.query(i, t => this.isEnabled(t))) {
                            ...
                            n.oW)(a.position, t)
                              ...
                              , c = (0,
                            n.uZ)((0,
                            n._X)(o.easing)(1 - r / e) * l, 0, o.maxSpeed)
                              , d = h.O.create(0 === r ? l : i / r * c, 0 === r ? l : s / r * c);
                            a.position.subFrom(d)
                        }
                }
                ,
                this._engine = t,
            ...
            async interact() {
                let t = this.container
                  , e = t.actualOptions
                  , i = t.interactivity.status === ty.Wt
                  ...
                  , l = o.onClick.mode;
                i && n && (0,
                s.dB)("attract", a) ? this._hoverAttract() : r && (0,
                s.dB)("attract", l) && this._clickAttract()
            }
            isEnabled(t) {
                let e = this.container
                  , i = e.actualOptions
                  , o = e.interactivity.mouse
                  , n = (t?.interactivity ?? i.interactivity).events;
                if ((!o.position || !n.onHover.enable) && (!o.clickPosition || !n.onClick.enable))
                    return !1;
            ...
            loadModeOptions(t, ...e) {
                for (let i of (t.attract || (t.attract = new tm),
                e))
        ...
        async function tb(t, e=!0) {
            await t.addInteractor("externalAttract", e => new tg(t,e), e)
        }
        var tw = i(6323);
        class tx {
            constructor() {
        ...
        class t_ extends G {
            constructor(t) {
                ...
                this._processBounce = (t, e, i) => {
                    for (let o of this.container.particles.quadTree.query(i, t => this.isEnabled(t)))
                        i instanceof tv.C ? (0,
                        s.kR)((0,
                        s.gy)(o), {
                            position: t,
                ...
                this._processMouseBounce = () => {
                    ...
                    s && !(s < 0) && i && this._processBounce(i, s, new tv.C(i.x,i.y,s + 10 * e))
                }
                ,
                this._singleSelectorBounce = (t, e) => {
                    ...
                    s.length && s.forEach(t => {
                        let s = i.retina.pixelRatio
                          ...
                          , n = t.offsetWidth / 2 * s
                          , a = 10 * s
                          , r = "circle" === e.type ? new tv.C(o.x,o.y,n + a) : new tw.A(t.offsetLeft * s - a,t.offsetTop * s - a,t.offsetWidth * s + 2 * a,t.offsetHeight * s + 2 * a);
                        this._processBounce(o, n, r)
                    }
                    )
                }
            }
            ...
            async interact() {
                let t = this.container
                  ...
                  , a = e.onDiv;
                i && o && (0,
                s.dB)("bounce", n) ? this._processMouseBounce() : (0,
                s.XD)("bounce", a, (t, e) => this._singleSelectorBounce(t, e))
            }
            isEnabled(t) {
                let e = this.container
                  , i = e.actualOptions
                  ...
                  , n = (t?.interactivity ?? i.interactivity).events
                  , a = n.onDiv;
                return o.position && n.onHover.enable && (0,
                s.dB)("bounce", n.onHover.mode) || (0,
                s.wm)("bounce", a)
            }
            loadModeOptions(t, ...e) {
                for (let i of (t.bounce || (t.bounce = new tx),
                e))
        ...
        async function tk(t, e=!0) {
            await t.addInteractor("externalBounce", t => new t_(t), e)
        }
        class tC {
            constructor() {
                this.distance = 200,
            ...
            load(t) {
                if (t) {
                    ...
                    void 0 !== t.color) {
                        let e = (0,
                        s.kJ)(this.color) ? void 0 : this.color;
                        this.color = (0,
                        s.KH)(t.color, t => o.O.create(e, t))
                    }
                    void 0 !== t.size && (this.size = t.size)
                }
            }
        ...
        class tz extends tC {
            ...
            get ids() {
                return (0,
                s.KH)(this.selectors, t => t.replace("#", ""))
            }
            set ids(t) {
                this.selectors = (0,
                s.KH)(t, t => `#${t}`)
        ...
        function tP(t, e, i, s) {
            return e >= i ? (0,
            n.uZ)(t + (e - i) * s, t, e) : e < i ? (0,
            n.uZ)(t - (i - e) * s, e, t) : void 0
        }
        class tO extends G {
            constructor(t) {
                super(t),
                this._clickBubble = () => {
                    ...
                    if (!o || o < 0)
                        return;
                    let a = t.particles.quadTree.queryCircle(i, o, t => this.isEnabled(t))
                      , {bubble: r} = t;
                    for (let e of a) {
                        if (!r.clicking)
                            continue;
                        ...
                        let h = {
                            ...
                            particlesObj: {
                                optValue: (0,
                                n.KI)(e.options.size.value) * t.retina.pixelRatio,
                                value: e.size.value
                            },
                            type: "size"
                        };
                        ...
                        let d = {
                            ...
                            particlesObj: {
                                optValue: (0,
                                n.KI)(e.options.opacity.value),
                                value: e.opacity?.value ?? 1
                            },
                            type: "opacity"
                        };
                        this._process(e, l, c, d),
                        !r.durationEnd && l <= o ? this._hoverBubbleColor(e, l) : delete e.bubble.color
                    }
                }
                ,
                this._hoverBubble = () => {
                    ...
                    if (i && !(i < 0) && void 0 !== e)
                        for (let s of t.particles.quadTree.queryCircle(e, i, t => this.isEnabled(t))) {
                            ...
                            n.Sp)(o, e)
                              , r = 1 - a / i;
                            a <= i ? r >= 0 && t.interactivity.status === ty.Wt && (this._hoverBubbleSize(s, r),
                            this._hoverBubbleOpacity(s, r),
                            this._hoverBubbleColor(s, r)) : this.reset(s),
                            t.interactivity.status === ty.aM && this.reset(s)
                        }
                }
                ,
                this._hoverBubbleColor = (t, e, i) => {
                    let o = this.container.actualOptions
                      , n = i ?? o.interactivity.modes.bubble;
                    if (n) {
                        ...
                        if (t.bubble.finalColor) {
                            if (n.mix) {
                                ...
                                t.bubble.color = i ? (0,
                                d.lC)((0,
                                d.oc)(i, t.bubble.finalColor, 1 - e, e)) : t.bubble.finalColor
                            } else
                ...
                this._hoverBubbleSize = (t, e, i) => {
                    ...
                    if (void 0 === o)
                        return;
                    let a = (0,
                    n.KI)(t.options.size.value) * s.retina.pixelRatio
                      , r = tP(t.size.value, o, a, e);
                ...
                this._singleSelectorHover = (t, e, i) => {
                    ...
                    a && n.length && n.forEach(e => {
                        let n = o.retina.pixelRatio
                          , r = {
                            x: (e.offsetLeft + e.offsetWidth / 2) * n,
                            y: (e.offsetTop + e.offsetHeight / 2) * n
                        }
                          , l = e.offsetWidth / 2 * n
                          , c = "circle" === i.type ? new tv.C(r.x,r.y,l) : new tw.A(e.offsetLeft * n,e.offsetTop * n,e.offsetWidth * n,e.offsetHeight * n);
                        for (let i of o.particles.quadTree.query(c, t => this.isEnabled(t))) {
                            if (!c.contains(i.getPosition()))
                                continue;
                            i.bubble.inRange = !0;
                            let o = a.divs
                              , n = (0,
            ...
            async interact(t) {
                let e = this.container.actualOptions.interactivity.events
                  ...
                  , c = e.onDiv;
                n && (0,
                s.dB)("bubble", a) ? this._hoverBubble() : r && (0,
                s.dB)("bubble", l) ? this._clickBubble() : (0,
                s.XD)("bubble", c, (e, i) => this._singleSelectorHover(t, e, i))
            }
            isEnabled(t) {
                let e = this.container
                  , i = e.actualOptions
                  , o = e.interactivity.mouse
                  , {onClick: n, onDiv: a, onHover: r} = (t?.interactivity ?? i.interactivity).events
                  , l = (0,
                s.wm)("bubble", a);
                return (!!l || !!r.enable && !!o.position || !!n.enable && !!o.clickPosition) && ((0,
                s.dB)("bubble", r.mode) || (0,
                s.dB)("bubble", n.mode) || l)
            }
            loadModeOptions(t, ...e) {
                for (let i of (t.bubble || (t.bubble = new tM),
                e))
        ...
        async function tS(t, e=!0) {
            await t.addInteractor("externalBubble", t => new tO(t), e)
        }
        class tD {
            constructor() {
                this.opacity = .5
        ...
        class tI extends G {
            ...
            isEnabled(t) {
                let e = this.container
                  ...
                  , o = (t?.interactivity ?? e.actualOptions.interactivity).events;
                return !!o.onHover.enable && !!i.position && (0,
                s.dB)("connect", o.onHover.mode)
            }
            loadModeOptions(t, ...e) {
                for (let i of (t.connect || (t.connect = new tT),
                e))
        ...
        async function tE(t, e=!0) {
            await t.addInteractor("externalConnect", t => new tI(t), e)
        }
        class tA {
            constructor() {
                this.blink = !1,
            ...
            load(t) {
                ...
                void 0 !== t.color && (this.color = o.O.create(this.color, t.color)),
        ...
        class tL extends G {
            ...
            async interact() {
                ...
                if (!e.modes.grab || !e.events.onHover.enable || t.interactivity.status !== ty.Wt)
                    return;
                ...
                if (s && !(s < 0))
                    for (let o of t.particles.quadTree.queryCircle(i, s, t => this.isEnabled(t))) {
                        ...
                        if (h <= 0)
                            continue;
                        let u = l.color ?? o.options.links?.color;
                        if (!t.particles.grabLineColor && u) {
                            let i = e.modes.grab.links;
                            t.particles.grabLineColor = (0,
                            d.Dt)(u, i.blink, i.consent)
                        }
                        let p = (0,
                        d.BE)(o, void 0, t.particles.grabLineColor);
            ...
            isEnabled(t) {
                let e = this.container
                  ...
                  , o = (t?.interactivity ?? e.actualOptions.interactivity).events;
                return o.onHover.enable && !!i.position && (0,
                s.dB)("grab", o.onHover.mode)
            }
            loadModeOptions(t, ...e) {
                for (let i of (t.grab || (t.grab = new tB),
                e))
                    t.grab.load(i?.grab)
            }
            reset() {}
        ...
        async function tG(t, e=!0) {
            await t.addInteractor("externalGrab", t => new tL(t), e)
        }
        class tq extends G {
            constructor(t) {
                super(t),
        ...
        async function tF(t, e=!0) {
            await t.addInteractor("externalPause", t => new tq(t), e)
        }
        class tH {
            constructor() {
                this.default = !0,
        ...
        class tW extends G {
            constructor(t) {
                ...
                this.handleClickMode = t => {
                    ...
                    if (o <= 0)
                        return;
                    let a = (0,
                    s.c8)([void 0, ...i.groups])
                      , r = void 0 !== a ? e.actualOptions.particles.groups[a] : void 0;
                    e.particles.push(o, e.interactivity.mouse, r, a)
                }
            }
            clear() {}
            init() {}
            ...
            loadModeOptions(t, ...e) {
                for (let i of (t.push || (t.push = new tH),
                e))
                    t.push.load(i?.push)
            }
            reset() {}
        }
        async function tZ(t, e=!0) {
            await t.addInteractor("externalPush", t => new tW(t), e)
        }
        class tV {
            constructor() {
                this.quantity = 2
        ...
        class tU extends G {
            constructor(t) {
                ...
                this.handleClickMode = t => {
                    ...
                    if (!i.interactivity.modes.remove || "remove" !== t)
                        return;
                    let s = (0,
                    n.Gu)(i.interactivity.modes.remove.quantity);
            ...
            loadModeOptions(t, ...e) {
                for (let i of (t.remove || (t.remove = new tV),
                e))
        ...
        async function tj(t, e=!0) {
            await t.addInteractor("externalRemove", t => new tU(t), e)
        }
        class tK {
            constructor() {
                this.distance = 200,
        ...
        class tX extends G {
            constructor(t, e) {
                ...
                this._clickRepulse = () => {
                    ...
                    i.clicking) {
                        ...
                        if (void 0 === a)
                            return;
                        let r = new tv.C(a.x,a.y,o);
                        for (let s of t.particles.quadTree.query(r, t => this.isEnabled(t))) {
                            let {dx: t, dy: r, distance: l} = (0,
                            n.oW)(a, s.position)
                              , c = l ** 2
                              , d = -o * e.speed / c;
                            if (c <= o) {
                                i.particles.push(s);
                                let e = h.O.create(t, r);
                                e.length = d,
                                s.velocity.setTo(e)
                            }
                        }
                ...
                this._hoverRepulse = () => {
                    ...
                    i && !(i < 0) && e && this._processRepulse(e, i, new tv.C(e.x,e.y,i))
                }
                ,
                this._processRepulse = (t, e, i, s) => {
                    let o = this.container
                      , a = o.particles.quadTree.query(i, t => this.isEnabled(t))
                      , r = o.actualOptions.interactivity.modes.repulse;
                    if (r)
                        for (let i of a) {
                            let {dx: o, dy: a, distance: l} = (0,
                            n.oW)(i.position, t)
                              , c = (s?.speed ?? r.speed) * r.factor
                              , d = (0,
                            n.uZ)((0,
                            n._X)(r.easing)(1 - l / e) * c, 0, r.maxSpeed)
                              , u = h.O.create(0 === l ? c : o / l * d, 0 === l ? c : a / l * d);
                            i.position.addTo(u)
                        }
                }
                ,
                this._singleSelectorRepulse = (t, e) => {
                    ...
                    n.length && n.forEach(t => {
                        let n = i.retina.pixelRatio
                          ...
                          , r = t.offsetWidth / 2 * n
                          , l = "circle" === e.type ? new tv.C(a.x,a.y,r) : new tw.A(t.offsetLeft * n,t.offsetTop * n,t.offsetWidth * n,t.offsetHeight * n)
                          , c = o.divs
                          , h = (0,
                        s.iC)(c, t);
                        this._processRepulse(a, r, l, h)
                    }
                    )
                }
                ,
            ...
            async interact() {
                let t = this.container
                  ...
                  , d = o.onDiv;
                i && a && (0,
                s.dB)("repulse", r) ? this._hoverRepulse() : c && (0,
                s.dB)("repulse", h) ? this._clickRepulse() : (0,
                s.XD)("repulse", d, (t, e) => this._singleSelectorRepulse(t, e))
            }
            isEnabled(t) {
                let e = this.container
                  , i = e.actualOptions
                  ...
                  , c = (0,
                s.wm)("repulse", a);
                if (!(c || r.enable && o.position || l.enable && o.clickPosition))
                    return !1;
                let h = r.mode
                  , d = l.mode;
                return (0,
            ...
            loadModeOptions(t, ...e) {
                for (let i of (t.repulse || (t.repulse = new tN),
                e))
        ...
        async function tY(t, e=!0) {
            await t.addInteractor("externalRepulse", e => new tX(t,e), e)
        }
        class tJ {
            constructor() {
                this.factor = 3,
        ...
        class tQ extends G {
            ...
            isEnabled(t) {
                let e = this.container
                  ...
                  , o = (t?.interactivity ?? e.actualOptions.interactivity).events;
                return o.onHover.enable && !!i.position && (0,
                s.dB)("slow", o.onHover.mode)
            }
            loadModeOptions(t, ...e) {
                for (let i of (t.slow || (t.slow = new tJ),
                e))
                    t.slow.load(i?.slow)
            }
            reset(t) {
        ...
        async function t0(t, e=!0) {
            await t.addInteractor("externalSlow", t => new tQ(t), e)
        }
        let t1 = [0, 4, 2, 1]
          , t2 = [8, 8, 4, 2];
        class t3 {
        ...
        async function t8(t, e, i, s, o, n) {
            ...
            a.sortFlag = (32 & r) == 32,
            a.reserved = (24 & r) >>> 3,
            l && (a.localColorTable = t5(t, 1 << (7 & r) + 1));
            let c = t => {
            ...
            if ((64 & r) == 64) {
                        ...
                        for (let t = 0, e = 0; ; ) {
                            ...
                            i === p) {
                                ...
                                for (let s = 0; s < l[i].length; s++) {
                                    let {r: o, g: n, b: r, a: d} = c(l[i][s]);
                                    h.data.set([o, n, r, d], t1[u] * a.width + t2[u] * e + t % (4 * a.width)),
                                    t += 4
                                }
                                l.length === 1 << o && o < 12 && o++
                            }
                            if (t === 4 * a.width * (e + 1) && (e++,
                            t1[u] + t2[u] * e >= a.height))
                                break
                        }
                    n?.(t.pos / (t.data.length - 1), s(!1) + 1, h, {
                        x: a.left,
                        y: a.top
                    }, {
                        width: e.width,
                ...
                a.image = h,
                a.bitmap = await createImageBitmap(h)
            } else {
                for (let t = 0, e = d + 1, i = 0, s = [[0]], o = -4; ; ) {
                    let n = t;
                    if (t = f(i, e),
                    i += e,
                    t === p) {
                        ...
                        if (t === p + 1)
                            break;
                        t >= s.length ? s.push(s[n].concat(s[n][0])) : n !== p && s.push(s[n].concat(s[t][0]));
                        for (let e = 0; e < s[t].length; e++) {
                            let {r: i, g: n, b: a, a: r} = c(s[t][e]);
                            h.data.set([i, n, a, r], o += 4)
                        }
                        s.length >= 1 << e && e < 12 && e++
                    }
                }
        ...
        async function t6(t, e, i, s, o, n) {
            switch (t.nextByte()) {
            case 59:
                return !0;
            case 44:
                await t8(t, e, i, s, o, n);
                break;
            case 33:
                await t4(t, e, s, o);
                break;
        ...
        async function t9(t, e, i) {
            ...
            let o = await s.arrayBuffer()
              ...
              , a = new t3(new Uint8ClampedArray(o));
            ...
            l && (n.globalColorTable = t5(a, 1 << (7 & r) + 1));
            let h = ( () => {
                try {
            ...
            try {
                do
                    ...
                    y = -1,
                    v = !1);
                while (!await t6(a, n, i, m, g, e));
                for (let t of (n.frames.length--,
                n.frames)) {
        ...
        let t7 = /(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d.]+%?\))|currentcolor/gi;
        async function et(t) {
            return new Promise(e => {
                ...
                i.addEventListener("error", () => {
                    ...
                    t.loading = !1,
                    (0,
                    s.jl)().error(`${ty.gK} loading image: ${t.source}`),
                    e()
                }
                ),
                i.src = t.source
        ...
        async function ei(t) {
            ...
            s.jl)().error(`${ty.gK} Image not found`),
            t.error = !0),
            t.loading = !1
        }
        class es {
            constructor(t) {
                this.loadImageShape = async t => {
                    if (!this._engine.loadImage)
                        throw Error(`${ty.gK} image shape not initialized`);
            ...
            draw(t, e, i, s, o) {
                ...
                if (n) {
                    ...
                    n.gif && n.gifData) {
                        ...
                        void 0 === e.gifLoopCount && (e.gifLoopCount = n.gifLoopCount ?? 0);
                        let r = e.gifFrame ?? 0
                          , l = {
                            x: -(.5 * n.gifData.width),
                        ...
                        !c.bitmap)
                            return;
                        switch (t.scale(i / n.gifData.width, i / n.gifData.height),
                        c.disposalMethod) {
                        case 4:
                        case 5:
                        case 6:
                        ...
                        case 2:
                            ...
                            t.drawImage(s, l.x, l.y),
                            a.clearRect(0, 0, s.width, s.height),
                            0 === n.gifData.globalColorTable.length ? a.putImageData(n.gifData.frames[0].image, l.x + c.left, l.y + c.top) : a.putImageData(n.gifData.backgroundImage, l.x, l.y);
                            break;
                        case 3:
                            {
                                let e = a.getImageData(0, 0, s.width, s.height);
                                a.drawImage(c.bitmap, c.left, c.top),
                                t.drawImage(s, l.x, l.y),
                                a.clearRect(0, 0, s.width, s.height),
            ...
            particleInit(t, e) {
                ...
                if (!n)
                    return;
                let a = s.replaceColor ?? s.replace_color ?? n.replaceColor;
                if (n.loading) {
                    setTimeout( () => {
                ...
                (async () => {
                    let t;
                    (t = n.svgData && o ? await function(t, e, i, s) {
        ...
        async function ea(t, e=!0) {
            t.loadImage || (t.loadImage = async e => {
                if (!e.name && !e.src)
                    throw Error(`${ty.gK} no image source provided`);
                ...
                !t.images.find(t => t.name === e.name || t.source === e.src))
                    try {
                        ...
                        t.images.push(i);
                        let s = e.gif ? ee : e.replaceColor ? ei : et;
                        await s(i)
                    } catch {
                        throw Error(`${ty.gK} ${e.name ?? e.src} not found`)
                    }
            }
            );
            let i = new en(t);
            await t.addPlugin(i, e),
            await t.addShape(["image", "images"], new es(t), e)
        }
        class er extends a.SW {
            constructor() {
                super(),
                this.sync = !1
            }
        ...
        class eh {
            ...
            init(t) {
                ...
                i && (t.life = {
                    ...
                    n.Gu)(i.delay.value) * (i.delay.sync ? 1 : (0,
                    n.sZ)()) / e.retina.reduceFactor * 1e3 : 0,
                    delayTime: 0,
                    duration: e.retina.reduceFactor ? (0,
                    n.Gu)(i.duration.value) * (i.duration.sync ? 1 : (0,
                    n.sZ)()) / e.retina.reduceFactor * 1e3 : 0,
                    time: 0,
                    count: i.count
                },
            ...
            loadOptions(t, ...e) {
                for (let i of (t.life || (t.life = new ec),
                e))
                    t.life.load(i?.life)
            }
            update(t, e) {
                ...
                n.Gu)(l.delay.value),
                i.duration = 1e3 * (0,
                n.Gu)(l.duration.value))
            }
        }
        async function ed(t, e=!0) {
            await t.addParticleUpdater("life", t => new eh(t), e)
        }
        class eu {
            draw(t, e, i) {
                let s = e.shapeData;
        ...
        async function ep(t, e=!0) {
            await t.addShape("line", new eu, e)
        }
        class ef {
            init() {}
            isEnabled(t) {
                return !(0,
                s.Kr)() && !t.destroyed && t.container.actualOptions.interactivity.events.onHover.parallax.enable
            }
            move(t) {
                let e = t.container
        ...
        async function ev(t, e=!0) {
            await t.addMover("parallax", () => new ef, e)
        }
        class ey {
            constructor(t) {
                this.container = t,
        ...
        class em extends ey {
            ...
            async interact(t) {
                ...
                for (let o of e.particles.quadTree.queryCircle(s, i)) {
                    if (t === o || !o.options.move.attract.enable || o.destroyed || o.spawning)
                        continue;
                    let e = o.getPosition()
                      , {dx: i, dy: a} = (0,
                    n.oW)(s, e)
        ...
        async function eg(t, e=!0) {
            await t.addInteractor("particlesAttract", t => new em(t), e)
        }
        function eb(t, e, i, s, o, a) {
            let r = (0,
            n.uZ)(t.options.collisions.absorb.speed * o.factor / 10, 0, s);
            t.size.value += r / 2,
            i.size.value -= r,
            s <= a && (i.size.value = 0,
            i.destroy())
        ...
        let ew = t => {
            ...
            n.Gu)(t.options.collisions.maxSpeed)),
        ...
        class e_ extends ey {
            ...
            async interact(t, e) {
                ...
                let i = this.container
                  , s = t.getPosition()
                  , o = t.getRadius();
                for (let a of i.particles.quadTree.queryCircle(s, 2 * o)) {
                    ...
                    n.Sp)(s, r) > o + l || function(t, e, i, s) {
                        switch (t.options.collisions.mode) {
                        case "absorb":
                            !function(t, e, i, s) {
                                let o = t.getRadius()
                                  , n = e.getRadius();
                                void 0 === o && void 0 !== n ? t.destroy() : void 0 !== o && void 0 === n ? e.destroy() : void 0 !== o && void 0 !== n && (o >= n ? eb(t, o, e, n, i, s) : eb(e, n, t, o, i, s))
                            }(t, e, i, s);
                            break;
                        case "bounce":
                            ex(t, e);
                            break;
                        case "destroy":
                            t.unbreakable || e.unbreakable || ex(t, e),
        ...
        async function ek(t, e=!0) {
            await t.addInteractor("particlesCollisions", t => new e_(t), e)
        }
        class eC extends tv.C {
            constructor(t, e, i, s) {
                super(t, e, i),
                this.canvasSize = s,
                this.canvasSize = {
            ...
            intersects(t) {
                ...
                if (void 0 !== t.radius) {
                    let i = new tv.C(e.x,e.y,2 * t.radius);
                    return super.intersects(i)
                }
                if (void 0 !== t.size) {
                    let i = new tw.A(e.x,e.y,2 * t.size.width,2 * t.size.height);
                    return super.intersects(i)
                }
                return !1
            }
        ...
        class ez {
            ...
            load(t) {
                t && (void 0 !== t.blur && (this.blur = t.blur),
                this.color = o.O.create(this.color, t.color),
                void 0 !== t.enable && (this.enable = t.enable))
            }
        }
        class eM {
        ...
        class eO extends ey {
            ...
            async interact(t) {
                ...
                let o = t.options.links
                  ...
                  , l = o.warp
                  , c = l ? new eC(e.x,e.y,r,s) : new tv.C(e.x,e.y,r);
                for (let h of i.particles.quadTree.query(c)) {
                    let i = h.options.links;
                    if (t === h || !i?.enable || o.id !== i.id || h.spawning || h.destroyed || !h.links || t.links.some(t => t.destination === h) || h.links.some(e => e.destination === t))
                        continue;
                    let c = h.getPosition();
                    if (c.x < 0 || c.y < 0 || c.x > s.width || c.y > s.height)
                        continue;
                    let d = function(t, e, i, s, o) {
                        let {dx: a, dy: r, distance: l} = (0,
                        n.oW)(t, e);
                        if (!o || l <= i)
                            return l;
                        let c = {
            ...
            loadParticlesOptions(t, ...e) {
                for (let i of (t.links || (t.links = new eP),
                e))
        ...
        async function eS(t, e=!0) {
            await t.addInteractor("particlesLinks", t => new eO(t), e)
        }
        function eD(t, e) {
            var i;
        ...
        class eT {
            constructor(t) {
                ...
                this._drawLinkLine = (t, e) => {
                    ...
                    s.canvas.draw(e => {
                        ...
                        if (!h)
                            return;
                        let p = t.retina.linksWidth ?? 0
                          , f = t.retina.linksDistance ?? 0
                          , {backgroundMask: v} = o;
                        !function(t) {
                            let e = !1
                              , {begin: i, end: s, maxDistance: o, context: a, canvasSize: r, width: l, backgroundMask: c, colorLine: h, opacity: u, links: p} = t;
                            if ((0,
                            n.Sp)(i, s) <= o)
                                (0,
                                tR.pS)(a, i, s),
                ...
                ,
                this._getLinkFrequency = (t, e) => eD([t, e], this._freqs.links),
                this._getTriangleFrequency = (t, e, i) => eD([t, e, i], this._freqs.triangles),
                this._freqs = {
                    links: new Map,
                    triangles: new Map
                }
            ...
            drawParticle(t, e) {
                ...
                if (!i || i.length <= 0)
                    return;
                let o = i.filter(t => s.links && this._getLinkFrequency(e, t.destination) <= s.links.frequency);
                for (let t of o)
        ...
        class eA {
            draw(t, e, i) {
                let s = this.getCenter(e, i)
                  ...
                  , r = Math.PI - 180 * (a - 2) / a * Math.PI / 180;
                if (t) {
                    t.beginPath(),
                    t.translate(s.x, s.y),
                    t.moveTo(0, 0);
        ...
        async function eG(t, e=!0) {
            await t.addShape("polygon", new eB, e)
        }
        async function eq(t, e=!0) {
            await t.addShape("triangle", new eL, e)
        }
        ...
        class eW extends a.SW {
            constructor() {
                super(),
                this.animation = new eH,
        ...
        class eZ {
            ...
            init(t) {
                ...
                t.rotate = {
                    ...
                    value: (0,
                    n.Gu)(e.value) * Math.PI / 180
                },
                t.pathRotation = e.path;
                let i = e.direction;
                switch ("random" === i && (i = Math.floor(2 * (0,
                n.sZ)()) > 0 ? "counter-clockwise" : "clockwise"),
                i) {
                ...
                n.Gu)(s.decay),
                t.rotate.velocity = (0,
                n.Gu)(s.speed) / 360 * this.container.retina.reduceFactor,
            ...
            loadOptions(t, ...e) {
                for (let i of (t.rotate || (t.rotate = new eW),
                e))
        ...
        async function eV(t, e=!0) {
            await t.addParticleUpdater("rotate", t => new eZ(t), e)
        }
        let eU = Math.sqrt(2);
        class ej {
            draw(t, e, i) {
        ...
        async function eK(t, e=!0) {
            await t.addShape(["edge", "square"], new ej, e)
        }
        class e$ {
            draw(t, e, i) {
                let s = e.sides
        ...
        class eY {
            ...
            init(t) {
                let e = this.container
                  , i = t.options
                  , o = (0,
                s.wA)(i.stroke, t.id, i.reduceDuplicates);
                t.strokeWidth = (0,
                n.Gu)(o.width) * e.retina.pixelRatio,
                t.strokeOpacity = (0,
                n.Gu)(o.opacity ?? 1),
                t.strokeAnimation = o.color?.animation;
                let a = (0,
                d.lN)(o.color) ?? t.getFillColor();
                a && (t.strokeColor = (0,
                d.bS)(a, t.strokeAnimation, e.retina.reduceFactor))
            }
            isEnabled(t) {
        ...
        async function eJ(t, e=!0) {
            await t.addParticleUpdater("strokeColor", t => new eY(t), e)
        }
        let eQ = ["text", "character", "char"];
        class e0 {
            draw(t, e, i, o) {
                let n = e.shapeData;
                if (void 0 === n)
                ...
                let r = e.text
                  ...
                  , d = e.fill
                  , u = r.length * i / 2;
                t.font = `${l} ${c} ${2 * Math.round(i)}px "${h}"`;
                let p = {
                    x: -u,
                    y: i / 2
                };
                t.globalAlpha = o,
                d ? t.fillText(r, p.x, p.y) : t.strokeText(r, p.x, p.y),
                t.globalAlpha = 1
            }
            getSidesCount() {
                return 12
            ...
            async init(t) {
                let e = t.actualOptions;
                if (eQ.find(t => (0,
                s.dB)(t, e.particles.shape.type))) {
                    let t = eQ.map(t => e.particles.shape.options[t]).find(t => !!t)
                      , i = [];
                    (0,
                    s.KH)(t, t => {
                        i.push((0,
                        s.mx)(t.font, t.weight))
                    }
                    ),
                    await Promise.all(i)
                }
            ...
            particleInit(t, e) {
                if (!e.shape || !eQ.includes(e.shape))
                    return;
                let i = e.shapeData;
                if (void 0 === i)
                    return;
                let o = i.value;
                void 0 !== o && (e.text = (0,
                s.wA)(o, e.randomIndexData))
            }
        }
        async function e1(t, e=!0) {
            await t.addShape(eQ, new e0, e)
        }
        ...
        class e4 {
            ...
            init(t) {
                ...
                s?.enable && (t.tilt.decay = 1 - (0,
                n.Gu)(s.decay),
                t.tilt.velocity = (0,
                n.Gu)(s.speed) / 360 * this.container.retina.reduceFactor,
                s.sync || (t.tilt.velocity *= (0,
                n.sZ)()))
            }
            isEnabled(t) {
            ...
            loadOptions(t, ...e) {
                for (let i of (t.tilt || (t.tilt = new e5),
                e))
                    t.tilt.load(i?.tilt)
            }
            update(t, e) {
                this.isEnabled(t) && function(t, e) {
                    if (!t.tilt || !t.options.tilt)
                        return;
                    let i = t.options.tilt.animation
                      , s = (t.tilt.velocity ?? 0) * e.factor
                      , o = 2 * Math.PI
                      , n = t.tilt.decay ?? 1;
                    i.enable && ("increasing" === t.tilt.status ? (t.tilt.value += s,
                    t.tilt.value > o && (t.tilt.value -= o)) : (t.tilt.value -= s,
                    t.tilt.value < 0 && (t.tilt.value += o)),
                    t.tilt.velocity && 1 !== n && (t.tilt.velocity *= n))
                }(t, e)
            }
        }
        async function e8(t, e=!0) {
            await t.addParticleUpdater("tilt", t => new e4(t), e)
        }
        class e6 {
            constructor() {
                this.enable = !1,
        ...
        class e9 {
            constructor() {
                this.lines = new e6,
                this.particles = new e6
            }
            load(t) {
                t && (this.lines.load(t.lines),
                this.particles.load(t.particles))
            }
        }
        class e7 {
            ...
            loadOptions(t, ...e) {
                for (let i of (t.twinkle || (t.twinkle = new e9),
                e))
        ...
        async function it(t, e=!0) {
            await t.addParticleUpdater("twinkle", () => new e7, e)
        }
        class ie {
            constructor() {
                this.angle = 50,
            ...
            load(t) {
                t && (void 0 !== t.angle && (this.angle = (0,
                n.Cs)(t.angle)),
                void 0 !== t.move && (this.move = (0,
                n.Cs)(t.move)))
            }
        }
        class ii {
            ...
            load(t) {
                if (t && (void 0 !== t.distance && (this.distance = (0,
                n.Cs)(t.distance)),
                void 0 !== t.enable && (this.enable = t.enable),
                void 0 !== t.speed)) {
                    if ((0,
        ...
        class is {
            ...
            init(t) {
                ...
                e?.enable ? t.wobble = {
                    ...
                    n.sZ)() * Math.PI * 2,
                    angleSpeed: (0,
                    n.Gu)(e.speed.angle) / 360,
                    moveSpeed: (0,
                    n.Gu)(e.speed.move) / 10
                } : t.wobble = {
                    angle: 0,
                    angleSpeed: 0,
                    moveSpeed: 0
                ...
                n.Gu)(e?.distance ?? 0) * this.container.retina.pixelRatio
            }
            isEnabled(t) {
                return !t.destroyed && !t.spawning && !!t.options.wobble?.enable
            }
            loadOptions(t, ...e) {
                for (let i of (t.wobble || (t.wobble = new ii),
                e))
            ...
            update(t, e) {
                this.isEnabled(t) && function(t, e) {
                    ...
                    let o = s.angleSpeed * e.factor
                      ...
                      , a = (t.retina.wobbleDistance ?? 0) * e.factor * n / (1e3 / 60)
                      , r = 2 * Math.PI
                      , {position: l} = t;
                    s.angle += o,
                    s.angle > r && (s.angle -= r),
                    l.x += a * Math.cos(s.angle),
                    l.y += a * Math.abs(Math.sin(s.angle))
                }(t, e)
            }
        }
        async function io(t, e=!0) {
            await t.addParticleUpdater("wobble", t => new is(t), e)
        }
        async function ia(t, e=!0) {
            await k(t, !1),
            await U(t, !1),
            await e8(t, !1),
            await it(t, !1),
