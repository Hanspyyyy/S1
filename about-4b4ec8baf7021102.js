(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[521], {
          ...
          , a = function() {
            function t(t, e, n) {
                ...
                this.count = function(t) {
                    ...
                    a.useEasing ? a.countDown ? a.frameVal = a.startVal - a.easingFn(e, 0, a.startVal - a.endVal, a.duration) : a.frameVal = a.easingFn(e, a.startVal, a.endVal - a.startVal, a.duration) : a.frameVal = a.startVal + (a.endVal - a.startVal) * (e / a.duration);
                    ...
                    e < a.duration ? a.rAF = requestAnimationFrame(a.count) : null !== a.finalEndVal ? a.update(a.finalEndVal) : a.options.onCompleteCallback && a.options.onCompleteCallback()
                }
                ,
                this.formatNumber = function(t) {
                    var e, n, i, r = (Math.abs(t).toFixed(a.options.decimalPlaces) + "").split(".");
                    if (e = r[0],
                    n = r.length > 1 ? a.options.decimal + r[1] : "",
                    a.options.useGrouping) {
                        i = "";
                        for (var s = 3, o = 0, l = 0, u = e.length; l < u; ++l)
                            a.options.useIndianSeparators && 4 === l && (s = 2,
                            o = 1),
                            0 !== l && o % s == 0 && (i = a.options.separator + i),
                            o++,
                            i = e[u - l - 1] + i;
                        e = i
                    }
            ...
            return t.prototype.handleScroll = function(t) {
                if (t && window && !t.once) {
                    ...
                    a < e && a > window.scrollY && t.paused ? (t.paused = !1,
                    setTimeout(function() {
                        return t.start()
                    }, t.options.scrollSpyDelay),
                    t.options.scrollSpyOnce && (t.once = !0)) : (window.scrollY > a || i > e) && !t.paused && t.reset()
                }
            }
            ,
    ...
    1580: function(t, e, n) {
        ...
        let d = [{
            ...
            info: [{
                ...
                icons: [o.gtO, o.FGx, o.zPb, o.huN, l.Xou, l.HA2, o.k7O]
            }, {
                title: "UI/UX Design",
                icons: [o.Tyb, l.RM8, l.dN3]
            }]
        }, {
            title: "awards",
            info: [{
                ...
                i.jsxs)("div", {
                    ...
                    i.jsxs)("div", {
                        ...
                        i.jsx)(a.E.p, {
                            ...
                            children: "10 years ago, I begin freelancing as a developer. Since then, I've done remote work for agencies, consulted for startups, and collabrated on digital products for business and consumer use."
                        }), (0,
                        i.jsx)(a.E.div, {
                            variants: (0,
                            f.J)("right", .6),
                    ...
                    i.jsxs)(a.E.div, {
                        ...
                        i.jsx)("div", {
                            ...
                            children: d.map( (n, a) => (0,
                            i.jsx)("div", {
                                className: "".concat(t === a && "text-accent after:w-[100%] after:bg-accent after:transition-all after:duration-300", " cursor-pointer capitalize xl:text-lg relative after:w-8 after:h-[2px] after:bg-white after:absolute after:-bottom-1 after:left-0"),
                                onClick: () => e(a),
                                children: n.title
                            }, a))
                        }), (0,
                            ...
                            children: d[t].info.map( (t, e) => {
                                ...
                                i.jsxs)("div", {
                                    ...
                                    i.jsx)("div", {
                                        ...
                                        children: null === (n = t.icons) || void 0 === n ? void 0 : n.map( (t, e) => (0,
                                        i.jsx)("div", {
    ...
    2204: function(t, e, n) {
        ...
        let i = (t, e) => ({
            hidden: {
                y: "up" === t ? 80 : "down" === t ? -80 : 0,
                opacity: 0,
                x: "left" === t ? 80 : "right" === t ? -80 : 0,
                transition: {
                    type: "tween",
                    duration: 1.5,
                    delay: e,
    ...
    7857: function(t, e, n) {
        ...
        var d = function(t, e) {
          ...
          , m = function(t) {
            var e = Object.fromEntries(Object.entries(t).filter(function(t) {
                    ...
                    if (null != n) {
                        ...
                        try {
                            ...
                            0 === e) {
                                ...
                                for (; !(l = (i = r.call(n)).done) && (o.push(i.value),
                                o.length !== e); l = !0)
                                    ;
                        } catch (t) {
                            u = !0,
              ...
              , V = i.useRef(!1)
              , E = f(function() {
                return d("string" == typeof a ? a : a.current, y)
            })
              , N = f(function(t) {
                var e = w.current;
                if (e && !t)
              ...
              , O = f(function() {
                ...
                c && c > 0 ? j.current = setTimeout(t, 1e3 * c) : t(),
                null == x || x({
                    pauseResume: S,
                    reset: A,
                    update: F
              ...
              , A = f(function() {
                N().el && (j.current && clearTimeout(j.current),
                N().reset(),
                null == v || v({
                    pauseResume: S,
                    start: C,
            ...
            return i.useEffect(function() {
                V.current ? o && P(!0) : (V.current = !0,
                P())
            }, [o, V, P, c, t.start, t.suffix, t.prefix, t.duration, t.separator, t.decimals, t.decimal, t.formattingFn]),
        ...
        e.ZP = function(t) {
            var e = t.className
              ...
              , h = m(s(s({}, c), {}, {
                ref: d,
                startOnMount: "function" != typeof r || 0 === t.delay,
    ...
    t.O(0, [445, 415, 888, 774, 179], function() {
        return t(t.s = 5401)
    }),
    _N_E = t.O()
}
