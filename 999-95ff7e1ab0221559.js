(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[999], {
    ...
    2546: function(e, t, i) {
        ...
        s.forwardRef)(function(e, t) {
            let {className: i, tag: m="div", wrapperTag: b="div", children: w, onSwiper: S, ...y} = void 0 === e ? {} : e
              , T = !1
              , [E,x] = (0,
            s.useState)("swiper")
              , [C,M] = (0,
            ...
            s.useRef)(null)
              , G = (0,
            s.useRef)(null)
              , {params: B, passedParams: N, rest: j, events: F} = function(e={}, t=!0) {
                let i = {
                    on: {}
                }
                  , s = {}
                  , n = {};
                l(i, r.ZP.defaults),
                l(i, r.ZP.extendedDefaults),
                i._emitClasses = !0,
                i.init = !1;
                let o = {}
                  , d = p.map(e => e.replace(/_/, ""));
                return Object.keys(Object.assign({}, e)).forEach(r => {
                    void 0 !== e[r] && (d.indexOf(r) >= 0 ? a(e[r]) ? (i[r] = {},
                    n[r] = {},
                    l(i[r], e[r]),
                    l(n[r], e[r])) : (i[r] = e[r],
                    n[r] = e[r]) : 0 === r.search(/on[A-Z]/) && "function" == typeof e[r] ? t ? s[`${r[2].toLowerCase()}${r.substr(3)}`] = e[r] : i.on[`${r[2].toLowerCase()}${r.substr(3)}`] = e[r] : o[r] = e[r])
                }
                ),
            ...
            ;
            O.current || W(),
            _.current && _.current.on("_beforeBreakpoint", R);
            let q = () => {
            ...
            (0,
            s.useEffect)( () => {
                !L.current && _.current && (_.current.emitSlidesClasses(),
                L.current = !0)
            }
            ),
            f( () => {
                ...
                O.current)
                    return _.current.destroyed && W(),
                    function({el: e, nextEl: t, prevEl: i, paginationEl: s, scrollbarEl: r, swiper: a}, l) {
                        n(l) && t && i && (a.params.navigation.nextEl = t,
                        a.originalParams.navigation.nextEl = t,
                        a.params.navigation.prevEl = i,
                        a.originalParams.navigation.prevEl = i),
                        o(l) && s && (a.params.pagination.el = s,
                        a.originalParams.pagination.el = s),
                        d(l) && r && (a.params.scrollbar.el = r,
            ...
            f( () => {
                ...
                let e = function(e, t, i, s, r) {
                    ...
                    return p.filter(e => "_" === e[0]).map(e => e.replace(/_/, "")).forEach(i => {
                        if (i in e && i in t) {
                            if (a(e[i]) && a(t[i])) {
                    ...
                    l
                }(N, z.current, V, A.current, e => e.key);
                return z.current = N,
                A.current = V,
                e.length && _.current && !_.current.destroyed && function({swiper: e, slides: t, passedParams: i, changedParams: s, nextEl: r, prevEl: n, scrollbarEl: o, paginationEl: d}) {
                    let c, p, u, h, f, m, g, v;
                    let b = s.filter(e => "children" !== e && "direction" !== e && "wrapperClass" !== e)
                      , {params: w, pagination: S, navigation: y, scrollbar: T, virtual: E, thumbs: x} = e;
                    s.includes("thumbs") && i.thumbs && i.thumbs.swiper && w.thumbs && !w.thumbs.swiper && (c = !0),
                    s.includes("controller") && i.controller && i.controller.control && w.controller && !w.controller.control && (p = !0),
                    s.includes("pagination") && i.pagination && (i.pagination.el || d) && (w.pagination || !1 === w.pagination) && S && !S.el && (u = !0),
                    s.includes("scrollbar") && i.scrollbar && (i.scrollbar.el || o) && (w.scrollbar || !1 === w.scrollbar) && T && !T.el && (h = !0),
                    s.includes("navigation") && i.navigation && (i.navigation.prevEl || n) && (i.navigation.nextEl || r) && (w.navigation || !1 === w.navigation) && y && !y.prevEl && !y.nextEl && (f = !0);
                    let C = t => {
                        e[t] && (e[t].destroy(),
                    ...
                    ;
                    s.includes("loop") && e.isElement && (w.loop && !i.loop ? m = !0 : !w.loop && i.loop ? g = !0 : v = !0),
                    b.forEach(e => {
                        if (a(w[e]) && a(i[e]))
                            l(w[e], i[e]),
                            ("navigation" === e || "pagination" === e || "scrollbar" === e) && "enabled"in i[e] && !i[e].enabled && C(e);
                        else {
                            let t = i[e];
                    ...
                    b.includes("controller") && !p && e.controller && e.controller.control && w.controller && w.controller.control && (e.controller.control = w.controller.control),
                    s.includes("children") && t && E && w.virtual.enabled && (E.slides = t,
                    E.update(!0)),
                    s.includes("children") && t && w.loop && (v = !0),
                    c && x.init() && x.update(!0),
                    p && (e.controller.control = w.controller.control),
                    u && (e.isElement && (!d || "string" == typeof d) && ((d = document.createElement("div")).classList.add("swiper-pagination"),
                    e.el.shadowEl.appendChild(d)),
                    d && (w.pagination.el = d),
                    S.init(),
                    S.render(),
                    S.update()),
                    h && (e.isElement && (!o || "string" == typeof o) && ((o = document.createElement("div")).classList.add("swiper-scrollbar"),
                    e.el.shadowEl.appendChild(o)),
                    o && (w.scrollbar.el = o),
                    T.init(),
                    T.updateSize(),
                    T.setTranslate()),
                    f && (e.isElement && (r && "string" != typeof r || ((r = document.createElement("div")).classList.add("swiper-button-next"),
                    e.el.shadowEl.appendChild(r)),
                    n && "string" != typeof n || ((n = document.createElement("div")).classList.add("swiper-button-prev"),
                    e.el.shadowEl.appendChild(n))),
                    r && (w.navigation.nextEl = r),
                    n && (w.navigation.prevEl = n),
                    y.init(),
                    y.update()),
            ...
            }, H["wrapper-start"], B.virtual ? function(e, t, i) {
                if (!i)
                    return null;
                let r = e => {
                    let i = e;
                  ...
                  , c = [];
                for (let e = o; e < d; e += 1)
                    e >= l && e <= n && c.push(t[r(e)]);
                return c.map( (t, i) => s.cloneElement(t, {
                    swiper: e,
                    style: a,
                    key: `slide-${i}`
                }))
            }(_.current, V, C) : V.map( (e, t) => s.cloneElement(e, {
                swiper: _.current,
                swiperSlideIndex: t
            })), H["wrapper-end"]), n(B) && s.createElement(s.Fragment, null, s.createElement("div", {
                ref: $,
                className: "swiper-button-prev"
            }), s.createElement("div", {
                ref: I,
                className: "swiper-button-next"
            })), d(B) && s.createElement("div", {
                ref: G,
                className: "swiper-scrollbar"
            }), o(B) && s.createElement("div", {
                ref: D,
        ...
        let S = (0,
        s.forwardRef)(function(e, t) {
            let {tag: i="div", children: r, className: a="", swiper: l, zoom: n, lazy: o, virtualIndex: d, swiperSlideIndex: p, ...u} = void 0 === e ? {} : e
              , h = (0,
            s.useRef)(null)
              , [g,v] = (0,
            ...
            f( () => {
                if (void 0 !== p && (h.current.swiperSlideIndex = p),
    ...
    6523: function(e, t, i) {
            ...
            for (let s = 1; s < e.length; s += 1) {
                ...
                if (null != r && ("undefined" != typeof window && void 0 !== window.HTMLElement ? !(r instanceof HTMLElement) : !r || 1 !== r.nodeType && 11 !== r.nodeType)) {
                    ...
                    for (let i = 0, s = e.length; i < s; i += 1) {
                        ...
                        void 0 !== a && a.enumerable && (f(t[s]) && f(r[s]) ? r[s].__swiper__ ? t[s] = r[s] : m(t[s], r[s]) : !f(t[s]) && f(r[s]) ? (t[s] = {},
                        r[s].__swiper__ ? t[s] = r[s] : m(t[s], r[s])) : t[s] = r[s])
                    }
                }
            }
            return t
        ...
        function O(e) {
            ...
            if (!l || !r.simulateTouch && "mouse" === e.pointerType || this.animating && r.preventInteractionOnTransition)
                return;
            !this.animating && r.cssMode && r.loop && this.loopFix();
            let n = e;
            n.originalEvent && (n = n.originalEvent);
            let o = n.target;
            if ("wrapper" === r.touchEventsTarget && !this.wrapperEl.contains(o) || "which"in n && 3 === n.which || "button"in n && n.button > 0 || s.isTouched && s.isMoved)
                return;
            let c = !!r.noSwipingClass && "" !== r.noSwipingClass
              , u = e.composedPath ? e.composedPath() : e.path;
            c && n.target && n.target.shadowRoot && u && (o = u[0]);
            ...
            let S = !0;
            o.matches(s.focusableElements) && (S = !1,
            "SELECT" === o.nodeName && (s.isTouched = !1)),
            t.activeElement && t.activeElement.matches(s.focusableElements) && t.activeElement !== o && t.activeElement.blur();
            let y = S && this.allowTouchMove && r.touchStartPreventDefault;
            (r.touchStartForcePreventDefault || y) && !o.isContentEditable && n.preventDefault(),
        ...
        function _(e) {
            ...
            let i = d()
              , s = this.touchEventsData
              , {params: r, touches: a, rtlTranslate: l, enabled: n} = this;
            if (!n || !r.simulateTouch && "mouse" === e.pointerType)
                return;
            let o = e;
            ...
            let c = s.evCache.findIndex(e => e.pointerId === o.pointerId);
            c >= 0 && (s.evCache[c] = o);
            let p = s.evCache.length > 1 ? s.evCache[0] : o
              , u = p.pageX
              , f = p.pageY;
            ...
            if (!this.allowTouchMove) {
                o.target.matches(s.focusableElements) || (this.allowClick = !1),
                s.isTouched && (Object.assign(a, {
                    startX: u,
                    startY: f,
            ...
            if (r.touchReleaseOnEdges && !r.loop) {
                ...
                } else if (u < a.startX && this.translate <= this.maxTranslate() || u > a.startX && this.translate >= this.minTranslate())
                    return
            }
            ...
            if (s.allowTouchCallbacks && this.emit("touchMove", o),
            ...
            if (this.params.threshold && Math.sqrt(m ** 2 + g ** 2) < this.params.threshold)
                return;
            if (void 0 === s.isScrolling) {
                let e;
                this.isHorizontal() && a.currentY === a.startY || this.isVertical() && a.currentX === a.startX ? s.isScrolling = !1 : m * m + g * g >= 25 && (e = 180 * Math.atan2(Math.abs(g), Math.abs(m)) / Math.PI,
                s.isScrolling = this.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle)
            }
            if (s.isScrolling && this.emit("touchMoveOpposite", o),
            void 0 === s.startMoving && (a.currentX !== a.startX || a.currentY !== a.startY) && (s.startMoving = !0),
            s.isScrolling || this.zoom && this.params.zoom && this.params.zoom.enabled && s.evCache.length > 1) {
                s.isTouched = !1;
                return
            }
            if (!s.startMoving)
            ...
            let S = this.params.loop && !r.cssMode;
            if (!s.isMoved) {
                if (S && this.loopFix({
            ...
            s.isMoved && w !== this.touchesDirection && S && Math.abs(v) >= 1 && (this.loopFix({
                direction: this.swipeDirection,
                setTranslate: !0
            }),
            t = !0),
            ...
            v > 0 ? (S && !t && s.currentTranslate > (r.centeredSlides ? this.minTranslate() - this.size / 2 : this.minTranslate()) && this.loopFix({
                direction: "prev",
                setTranslate: !0,
                activeSlideIndex: 0
            }),
            s.currentTranslate > this.minTranslate() && (y = !1,
            r.resistance && (s.currentTranslate = this.minTranslate() - 1 + (-this.minTranslate() + s.startTranslate + v) ** T))) : v < 0 && (S && !t && s.currentTranslate < (r.centeredSlides ? this.maxTranslate() + this.size / 2 : this.maxTranslate()) && this.loopFix({
                direction: "next",
                setTranslate: !0,
            ...
            s.currentTranslate < this.maxTranslate() && (y = !1,
            r.resistance && (s.currentTranslate = this.maxTranslate() + 1 - (this.maxTranslate() - s.startTranslate - v) ** T))),
            ...
            r.followFinger && !r.cssMode && ((r.freeMode && r.freeMode.enabled && this.freeMode || r.watchSlidesProgress) && (this.updateActiveIndex(),
            this.updateSlidesClasses()),
            r.freeMode && r.freeMode.enabled && this.freeMode && this.freeMode.onTouchMove(),
        ...
        function z(e) {
            ...
            if (r >= 0 && s.evCache.splice(r, 1),
            ["pointercancel", "pointerout", "pointerleave"].includes(e.type) && !("pointercancel" === e.type && (i.browser.isSafari || i.browser.isWebView)))
                return;
            let {params: a, touches: l, rtlTranslate: n, slidesGrid: o, enabled: d} = i;
            ...
            if (i.allowClick) {
                ...
                i.emit("tap click", c),
                f < 300 && p - s.lastClickTime < 300 && i.emit("doubleTap doubleClick", c)
            }
            if (s.lastClickTime = h(),
            u( () => {
            ...
            s.isMoved = !1,
            s.startMoving = !1,
            t = a.followFinger ? n ? i.translate : -i.translate : -s.currentTranslate,
            a.cssMode)
                return;
            ...
            if (f > a.longSwipesMs) {
                ...
                "next" === i.swipeDirection && (w >= a.longSwipesRatio ? i.slideTo(a.rewind && i.isEnd ? v : m + S) : i.slideTo(m)),
                "prev" === i.swipeDirection && (w > 1 - a.longSwipesRatio ? i.slideTo(m + S) : null !== b && w < 0 && Math.abs(w) > a.longSwipesRatio ? i.slideTo(b) : i.slideTo(m))
            } else {
                if (!a.shortSwipes) {
                    i.slideTo(i.activeIndex);
                    return
                }
                i.navigation && (c.target === i.navigation.nextEl || c.target === i.navigation.prevEl) ? c.target === i.navigation.nextEl ? i.slideTo(m + S) : i.slideTo(m) : ("next" === i.swipeDirection && i.slideTo(null !== v ? v : m + S),
        ...
        function A() {
            ...
            e.updateSlidesClasses();
            let n = l && t.loop;
            "auto" !== t.slidesPerView && !(t.slidesPerView > 1) || !e.isEnd || e.isBeginning || e.params.centeredSlides || n ? e.params.loop && !l ? e.slideToLoop(e.realIndex, 0, !1, !0) : e.slideTo(e.activeIndex, 0, !1, !0) : e.slideTo(e.slides.length - 1, 0, !1, !0),
        ...
        let N = (e, t) => {
            ...
            s.updateOnWindowResize ? e[t](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", A, !0) : e[t]("observerUpdate", A, !0),
            r[o]("load", e.onLoad, {
                capture: !0
            })
        }
        ...
        let V = {
            ...
            update: {
                updateSize: function() {
                    ...
                    0 === e && this.isHorizontal() || 0 === t && this.isVertical() || (e = e - parseInt(S(i, "padding-left") || 0, 10) - parseInt(S(i, "padding-right") || 0, 10),
                    t = t - parseInt(S(i, "padding-top") || 0, 10) - parseInt(S(i, "padding-bottom") || 0, 10),
                    Number.isNaN(e) && (e = 0),
                    Number.isNaN(t) && (t = 0),
                    Object.assign(this, {
                        width: e,
                ...
                updateSlides: function() {
                    ...
                    let r = t.params
                      , {wrapperEl: a, slidesEl: l, size: n, rtlTranslate: o, wrongRTL: d} = t
                    ...
                    if (void 0 === n)
                        return;
                    "string" == typeof C && C.indexOf("%") >= 0 ? C = parseFloat(C.replace("%", "")) / 100 * n : "string" == typeof C && (C = parseFloat(C)),
                    t.virtualSize = -C,
                    u.forEach(e => {
                    ...
                    r.centeredSlides && r.cssMode && (g(a, "--swiper-centered-offset-before", ""),
                    ...
                    for (let a = 0; a < h; a += 1) {
                        ...
                        if (e = 0,
                        u[a] && (l = u[a]),
                        L && t.grid.updateSlide(a, l, h, i),
                        !u[a] || "none" !== S(l, "display")) {
                            if ("auto" === r.slidesPerView) {
                                ...
                                r.roundLengths)
                                    e = t.isHorizontal() ? x(l, "width", !0) : x(l, "height", !0);
                                else {
                                    let t = s(n, "width")
                                      , i = s(n, "padding-left")
                                      , r = s(n, "padding-right")
                                    ...
                                    if (d && "border-box" === d)
                                        ...
                                        let {clientWidth: s, offsetWidth: n} = l;
                                        e = t + i + r + a + o + (n - s)
                                    }
                                }
                                ...
                                r.roundLengths && (e = Math.floor(e)),
                                u[a] && (u[a].style[i("width")] = `${e}px`);
                            u[a] && (u[a].swiperSlideSize = e),
                            v.push(e),
                            r.centeredSlides ? (M = M + e / 2 + P / 2 + C,
                            0 === P && 0 !== a && (M = M - n / 2 - C),
                            0 === a && (M = M - n / 2 - C),
                            .001 > Math.abs(M) && (M = 0),
                            r.roundLengths && (M = Math.floor(M)),
                            k % r.slidesPerGroup == 0 && f.push(M),
                            m.push(M)) : (r.roundLengths && (M = Math.floor(M)),
                            (k - Math.min(t.params.slidesPerGroupSkip, k)) % t.params.slidesPerGroup == 0 && f.push(M),
                            m.push(M),
                            M = M + e + C),
                            t.virtualSize += e + C,
                            P = e,
                    ...
                    if (t.virtualSize = Math.max(t.virtualSize, n) + y,
                    o && d && ("slide" === r.effect || "coverflow" === r.effect) && (a.style.width = `${t.virtualSize + C}px`),
                    r.setWrapperSize && (a.style[i("width")] = `${t.virtualSize + C}px`),
                    L && t.grid.updateWrapperSize(e, f, i),
                    !r.centeredSlides) {
                        let e = [];
                        for (let i = 0; i < f.length; i += 1) {
                            let s = f[i];
                            r.roundLengths && (s = Math.floor(s)),
                            f[i] <= t.virtualSize - n && e.push(s)
                        }
                        f = e,
                    ...
                    r.centeredSlides && r.cssMode && !r.centeredSlidesBounds) {
                        g(a, "--swiper-centered-offset-before", `${-f[0]}px`),
                        g(a, "--swiper-centered-offset-after", `${t.size / 2 - v[v.length - 1] / 2}px`);
                        let e = -t.snapGrid[0]
                          , i = -t.slidesGrid[0];
                        t.snapGrid = t.snapGrid.map(t => t + e),
                        t.slidesGrid = t.slidesGrid.map(e => e + i)
                    }
                    if (h !== p && t.emit("slidesLengthChange"),
                    f.length !== T && (t.params.watchOverflow && t.checkOverflow(),
                ...
                updateSlidesProgress: function(e=this && this.translate || 0) {
                    ...
                    for (let e = 0; e < i.length; e += 1) {
                        ...
                        (p >= 0 && p < this.size - 1 || u > 1 && u <= this.size || p <= 0 && u >= this.size) && (this.visibleSlides.push(n),
                ...
                updateSlidesClasses: function() {
                    ...
                    let {slides: t, params: i, slidesEl: s, activeIndex: r} = this
                      ...
                      , l = e => b(s, `.${i.slideClass}${e}, swiper-slide${e}`)[0];
                    if (t.forEach(e => {
                ...
                updateActiveIndex: function(e) {
                    ...
                    c === n) {
                        ...
                        s.params.loop && s.virtual && s.params.virtual.enabled && (s.realIndex = p(c));
                        return
                    }
                    i = s.virtual && l.virtual.enabled && l.loop ? p(c) : s.slides[c] ? parseInt(s.slides[c].getAttribute("data-swiper-slide-index") || c, 10) : c,
                    Object.assign(s, {
                        previousSnapIndex: d,
                        snapIndex: t,
                        previousRealIndex: o,
                ...
                updateClickedSlide: function(e) {
                    ...
                    if (s && r)
                        this.clickedSlide = s,
                        this.virtual && this.params.virtual.enabled ? this.clickedIndex = parseInt(s.getAttribute("data-swiper-slide-index"), 10) : this.clickedIndex = t;
                    else {
            ...
            translate: {
                getTranslate: function(e=this.isHorizontal() ? "x" : "y") {
                    ...
                    let a = function(e, t="x") {
                        ...
                        return a.WebKitCSSMatrix ? ((s = l.transform || l.webkitTransform).split(",").length > 6 && (s = s.split(", ").map(e => e.replace(",", ".")).join(", ")),
                        r = new a.WebKitCSSMatrix("none" === s ? "" : s)) : i = (r = l.MozTransform || l.OTransform || l.MsTransform || l.msTransform || l.transform || l.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","),
                ...
                setTranslate: function(e, t) {
                    ...
                    s.cssMode ? r[this.isHorizontal() ? "scrollLeft" : "scrollTop"] = this.isHorizontal() ? -l : -n : s.virtualTranslate || (this.isHorizontal() ? l -= this.cssOverflowAdjustment() : n -= this.cssOverflowAdjustment(),
                ...
                translateTo: function(e=0, t=this.params.speed, i=!0, s=!0, r) {
                    ...
                    l.setTranslate(a),
                    i && (l.emit("beforeTransitionStart", t, r),
            ...
            slide: {
                slideTo: function(e=0, t=this.params.speed, i=!0, s, r) {
                    ...
                    let l = this
                      , n = e;
                    n < 0 && (n = 0);
                    let {params: o, snapGrid: d, slidesGrid: c, previousIndex: p, activeIndex: u, rtlTranslate: h, wrapperEl: f, enabled: m} = l;
                    if (l.animating && o.preventInteractionOnTransition || !m && !s && !r)
                        return !1;
                    ...
                    if (l.initialized && n !== u && (!l.allowSlideNext && (h ? w > l.translate && w > l.minTranslate() : w < l.translate && w < l.minTranslate()) || !l.allowSlidePrev && w > l.translate && w > l.maxTranslate() && (u || 0) !== n))
                        return !1;
                    if (n !== (p || 0) && i && l.emit("beforeSlideChangeStart"),
                    l.updateProgress(w),
                    ...
                    0 === t ? l.transitionEnd(i, a) : l.animating || (l.animating = !0,
                ...
                slideToLoop: function(e=0, t=this.params.speed, i=!0, s) {
                    "string" == typeof e && (e = parseInt(e, 10));
                    let r = e;
                    return this.params.loop && (this.virtual && this.params.virtual.enabled ? r += this.virtual.slidesBefore : r = this.getSlideIndexByData(r)),
                    this.slideTo(r, t, i, s)
                },
                slideNext: function(e=this.params.speed, t=!0, i) {
                    let {enabled: s, params: r, animating: a} = this;
                    if (!s)
                        return this;
                    let l = r.slidesPerGroup;
                    "auto" === r.slidesPerView && 1 === r.slidesPerGroup && r.slidesPerGroupAuto && (l = Math.max(this.slidesPerViewDynamic("current", !0), 1));
                    let n = this.activeIndex < r.slidesPerGroupSkip ? 1 : l
                      , o = this.virtual && r.virtual.enabled;
                    if (r.loop) {
                        if (a && !o && r.loopPreventsSliding)
                            return !1;
                        this.loopFix({
                            direction: "next"
                        }),
                    ...
                    return r.rewind && this.isEnd ? this.slideTo(0, e, t, i) : this.slideTo(this.activeIndex + n, e, t, i)
                },
                slidePrev: function(e=this.params.speed, t=!0, i) {
                    let {params: s, snapGrid: r, slidesGrid: a, rtlTranslate: l, enabled: n, animating: o} = this;
                    if (!n)
                        return this;
                    ...
                    let p = c(l ? this.translate : -this.translate)
                      , u = r.map(e => c(e))
                      , h = r[u.indexOf(p) - 1];
                    ...
                    let f = 0;
                    if (void 0 !== h && ((f = a.indexOf(h)) < 0 && (f = this.activeIndex - 1),
                    "auto" === s.slidesPerView && 1 === s.slidesPerGroup && s.slidesPerGroupAuto && (f = Math.max(f = f - this.slidesPerViewDynamic("previous", !0) + 1, 0))),
                ...
                slideToClickedSlide: function() {
                    ...
                    if (i.loop) {
                        ...
                        a = t.getSlideIndex(b(s, `${l}[data-swiper-slide-index="${e}"]`)[0]),
                        u( () => {
                            t.slideTo(a)
                        }
            ...
            loop: {
                loopCreate: function(e) {
                    ...
                    !t.loop || this.virtual && this.params.virtual.enabled || (b(i, `.${t.slideClass}, swiper-slide`).forEach( (e, t) => {
                ...
                loopFix: function({slideRealIndex: e, slideTo: t=!0, direction: i, setTranslate: s, activeSlideIndex: r, byController: a, byMousewheel: l}={}) {
                    let n = this;
                    if (!n.params.loop)
                        return;
                    n.emit("beforeLoopFix");
                    let {slides: o, allowSlidePrev: d, allowSlideNext: c, slidesEl: p, params: u} = n;
                    if (n.allowSlidePrev = !0,
                    n.allowSlideNext = !0,
                    n.virtual && u.virtual.enabled) {
                        t && (u.centeredSlides || 0 !== n.snapIndex ? u.centeredSlides && n.snapIndex < u.slidesPerView ? n.slideTo(n.virtual.slides.length + n.snapIndex, 0, !1, !0) : n.snapIndex === n.snapGrid.length - 1 && n.slideTo(n.virtual.slidesBefore, 0, !1, !0) : n.slideTo(n.virtual.slides.length, 0, !1, !0)),
                        n.allowSlidePrev = d,
                        n.allowSlideNext = c,
                        n.emit("loopFix");
                        return
                    ...
                    } else if (r > n.slides.length - 2 * f) {
                        y = Math.max(r - (n.slides.length - 2 * f), u.slidesPerGroup);
                        for (let e = 0; e < y; e += 1) {
                            let t = e - Math.floor(e / o.length) * o.length;
                            g.push(t)
                        }
                    ...
                    if (w && m.forEach(e => {
                        n.slides[e].swiperLoopMoveDOM = !0,
                        p.prepend(n.slides[e]),
                        n.slides[e].swiperLoopMoveDOM = !1
                    }
                    ),
                    b && g.forEach(e => {
                        n.slides[e].swiperLoopMoveDOM = !0,
                        ...
                        if (m.length > 0 && w) {
                            if (void 0 === e) {
                                let e = n.slidesGrid[v]
                                  , t = n.slidesGrid[v + S] - e;
                                l ? n.setTranslate(n.translate - t) : (n.slideTo(v + S, 0, !1, !0),
                                s && (n.touches[n.isHorizontal() ? "startX" : "startY"] += t))
                            } else
                                s && n.slideToLoop(e, 0, !1, !0)
                        } else if (g.length > 0 && b) {
                            if (void 0 === e) {
                                let e = n.slidesGrid[v]
                                  , t = n.slidesGrid[v - y] - e;
                                l ? n.setTranslate(n.translate - t) : (n.slideTo(v - y, 0, !1, !0),
                                s && (n.touches[n.isHorizontal() ? "startX" : "startY"] += t))
                            } else
                                n.slideToLoop(e, 0, !1, !0)
                        }
                    }
                    if (n.allowSlidePrev = d,
                    n.allowSlideNext = c,
                    n.controller && n.controller.control && !a) {
                        let t = {
                            slideRealIndex: e,
                            slideTo: !1,
                            direction: i,
            ...
            events: {
                attachEvents: function() {
                    ...
                    this.onTouchMove = _.bind(this),
                    this.onTouchEnd = z.bind(this),
                    t.cssMode && (this.onScroll = $.bind(this)),
                    this.onClick = I.bind(this),
                    this.onLoad = D.bind(this),
                    G || (e.addEventListener("touchstart", B),
                    G = !0),
                    N(this, "on")
                },
            ...
            breakpoints: {
                setBreakpoint: function() {
                    ...
                    let n = (l in a ? a[l] : void 0) || e.originalParams
                      ...
                      , d = j(e, n)
                      , c = s.enabled;
                    o && !d ? (r.classList.remove(`${s.containerModifierClass}grid`, `${s.containerModifierClass}grid-column`),
                    e.emitContainerClasses()) : !o && d && (r.classList.add(`${s.containerModifierClass}grid`),
                    ...
                    let p = n.direction && n.direction !== s.direction
                      , u = s.loop && (n.slidesPerView !== s.slidesPerView || p);
        ...
        class R {
                ...
                l.device = function(e={}) {
                    return r || (r = function({userAgent: e}={}) {
                        let t = C()
                          ...
                          , h = "MacIntel" === s;
                        return !d && h && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${n}`) >= 0 && ((d = r.match(/(Version)\/([\d.]+)/)) || (d = [0, 1, "13_0_0"]),
                        h = !1),
                        o && "Win32" !== s && (a.os = "android",
                        a.android = !0),
                        (d || u || c) && (a.os = "ios",
                        a.ios = !0),
                        a
            ...
            getSlideIndex(e) {
                let {slidesEl: t, params: i} = this
                  , s = y(b(t, `.${i.slideClass}, swiper-slide`)[0]);
                return y(e) - s
            }
            ...
            mount(e) {
                ...
                let s = () => `.${(t.params.wrapperClass || "").trim().split(" ").join(".")}`
                  , r = i && i.shadowRoot && i.shadowRoot.querySelector ? i.shadowRoot.querySelector(s()) : b(i, s())[0];
                return !r && t.params.createElements && (r = w("div", t.params.wrapperClass),
                i.append(r),
            ...
            static use(e) {
                return Array.isArray(e) ? e.forEach(e => R.installModule(e)) : R.installModule(e),
                R
            }
        }
        ...
        R.use([function({swiper: e, on: t, emit: i}) {
            let s = p()
              , r = null
              , a = null
              , l = () => {
        ...
        function X({swiper: e, extendParams: t, on: i, emit: s}) {
            ...
            function l(t, i) {
                ...
                (t = r(t)).forEach(t => {
                    t && (t.classList[i ? "add" : "remove"](...s.disabledClass.split(" ")),
            ...
            function c() {
                ...
                s = r(s);
                let l = (i, s) => {
                    i && i.addEventListener("click", "next" === s ? d : o),
                    !e.enabled && i && i.classList.add(...t.lockClass.split(" "))
                }
                ;
                i.forEach(e => l(e, "next")),
                s.forEach(e => l(e, "prev"))
            }
            function p() {
                let {nextEl: t, prevEl: i} = e.navigation;
                t = r(t),
            ...
            i("click", (t, i) => {
                let {nextEl: a, prevEl: l} = e.navigation;
                a = r(a),
                l = r(l);
                let n = i.target;
                if (e.params.navigation.hideOnClick && !l.includes(n) && !a.includes(n)) {
                    ...
                    if (e.pagination && e.params.pagination && e.params.pagination.clickable && (e.pagination.el === n || e.pagination.el.contains(n)))
                        return;
                    a.length ? t = a[0].classList.contains(e.params.navigation.hiddenClass) : l.length && (t = l[0].classList.contains(e.params.navigation.hiddenClass)),
                    !0 === t ? s("navigationShow") : s("navigationHide"),
                    [...a, ...l].filter(e => !!e).forEach(t => t.classList.toggle(e.params.navigation.hiddenClass))
                }
            }
            );
            let u = () => {
        ...
        function U({swiper: e, extendParams: t, on: i, emit: s}) {
            let r;
            ...
            let l = 0
              , n = e => (Array.isArray(e) || (e = [e].filter(e => !!e)),
            e);
            function o() {
            ...
            function d(t, i) {
                ...
                t && (t = t[`${"prev" === i ? "previous" : "next"}ElementSibling`]) && (t.classList.add(`${s}-${i}`),
                (t = t[`${"prev" === i ? "previous" : "next"}ElementSibling`]) && t.classList.add(`${s}-${i}-${i}`))
            }
            function c(t) {
            ...
            function p() {
                ...
                t = e.params.slidesPerGroup > 1 ? Math.floor(e.realIndex / e.params.slidesPerGroup) : e.realIndex) : void 0 !== e.snapIndex ? (t = e.snapIndex,
                i = e.previousSnapIndex) : (i = e.previousIndex || 0,
                t = e.activeIndex || 0),
                "bullets" === c.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                    let s, n, o;
                    let u = e.pagination.bullets;
                    if (c.dynamicBullets && (r = x(u[0], e.isHorizontal() ? "width" : "height", !0),
                    p.forEach(t => {
                        t.style[e.isHorizontal() ? "width" : "height"] = `${r * (c.dynamicMainBullets + 4)}px`
                    }
                    ),
                    c.dynamicMainBullets > 1 && void 0 !== i && ((l += t - (i || 0)) > c.dynamicMainBullets - 1 ? l = c.dynamicMainBullets - 1 : l < 0 && (l = 0)),
                    o = ((n = (s = Math.max(t - l, 0)) + (Math.min(u.length, c.dynamicMainBullets) - 1)) + s) / 2),
                    u.forEach(e => {
                    ...
                    p.length > 1)
                        u.forEach(i => {
                            let r = y(i);
                            r === t ? i.classList.add(...c.bulletActiveClass.split(" ")) : e.isElement && i.setAttribute("part", "bullet"),
                            c.dynamicBullets && (r >= s && r <= n && i.classList.add(...`${c.bulletActiveClass}-main`.split(" ")),
                            r === s && d(i, "prev"),
                            r === n && d(i, "next"))
                        }
                        );
                        ...
                        let i = u[t];
                        if (i && i.classList.add(...c.bulletActiveClass.split(" ")),
                        e.isElement && u.forEach( (e, i) => {
                        ...
                        c.dynamicBullets) {
                            let e = u[s]
                              , t = u[n];
                            for (let e = s; e <= n; e += 1)
                                u[e] && u[e].classList.add(...`${c.bulletActiveClass}-main`.split(" "));
                            d(e, "prev"),
                            d(t, "next")
                        }
                    }
                ...
                p.forEach( (i, r) => {
                    ...
                    i.querySelectorAll(Y(c.totalClass)).forEach(e => {
                        e.textContent = c.formatFractionTotal(h)
                    }
                    )),
                    "progressbar" === c.type) {
                        let s;
                        ...
                        i.querySelectorAll(Y(c.progressbarFillClass)).forEach(t => {
                            t.style.transform = `translate3d(0,0,0) scaleX(${a}) scaleY(${l})`,
                            t.style.transitionDuration = `${e.params.speed}ms`
                        }
                        )
                    }
                    "custom" === c.type && c.renderCustom ? (i.innerHTML = c.renderCustom(e, t + 1, h),
                    0 === r && s("paginationRender", i)) : (0 === r && s("paginationRender", i),
            ...
            function u() {
                ...
                if ("bullets" === t.type) {
                    ...
                    for (let i = 0; i < s; i += 1)
                        t.renderBullet ? a += t.renderBullet.call(e, i, t.bulletClass) : a += `<${t.bulletElement} ${e.isElement ? 'part="bullet"' : ""} class="${t.bulletClass}"></${t.bulletElement}>`
                }
                ...
                r.forEach(i => {
                    ...
                    "bullets" === t.type && e.pagination.bullets.push(...i.querySelectorAll(Y(t.bulletClass)))
                }
                ),
            ...
            function h() {
                ...
                t || (t = i.el),
                t && 0 !== t.length && (e.params.uniqueNavElements && "string" == typeof i.el && Array.isArray(t) && t.length > 1 && (t = [...e.el.querySelectorAll(i.el)]).length > 1 && (t = t.filter(t => T(t, ".swiper")[0] === e.el)[0]),
            ...
            i("init", () => {
                !1 === e.params.pagination.enabled ? m() : (h(),
                u(),
                p())
            }
            ),
            ...
            i("click", (t, i) => {
                let r = i.target
                  , {el: a} = e.pagination;
                if (Array.isArray(a) || (a = [a].filter(e => !!e)),
                e.params.pagination.el && e.params.pagination.hideOnClick && a && a.length > 0 && !r.classList.contains(e.params.pagination.bulletClass)) {
                    if (e.navigation && (e.navigation.nextEl && r === e.navigation.nextEl || e.navigation.prevEl && r === e.navigation.prevEl))
                        return;
                    !0 === a[0].classList.contains(e.params.pagination.hiddenClass) ? s("paginationShow") : s("paginationHide"),
            ...
            let m = () => {
                ...
                let {el: t} = e.pagination;
                t && (t = n(t)).forEach(t => t.classList.add(e.params.pagination.paginationDisabledClass)),
                f()
            }
            ;
            Object.assign(e.pagination, {
                enable: () => {
                    ...
                    let {el: t} = e.pagination;
                    t && (t = n(t)).forEach(t => t.classList.remove(e.params.pagination.paginationDisabledClass)),
                    h(),
                    u(),
                    p()
                }
        ...
        function K({swiper: e, extendParams: t, emit: i, once: s}) {
            t({
                freeMode: {
                    enabled: !1,
                    momentum: !0,
            ...
            Object.assign(e, {
                freeMode: {
                    ...
                    onTouchEnd: function({currentPos: t}) {
                        if (e.params.cssMode)
                            return;
                        let {params: r, wrapperEl: a, rtlTranslate: l, snapGrid: n, touchEventsData: o} = e
                          , d = h() - o.touchStartTime;
                        if (t < -e.minTranslate()) {
                        ...
                        if (r.freeMode.momentum) {
                            ...
                            if (o.velocities.length > 1) {
                                ...
                                (a > 150 || h() - t.time > 300) && (e.velocity = 0)
                            } else
                                e.velocity = 0;
                            ...
                            if (u < e.maxTranslate())
                                r.freeMode.momentumBounce ? (u + e.maxTranslate() < -m && (u = e.maxTranslate() - m),
                                t = e.maxTranslate(),
                                f = !0,
                                o.allowMomentumBounce = !0) : u = e.maxTranslate(),
                                r.loop && r.centeredSlides && (d = !0);
                            else if (u > e.minTranslate())
                                r.freeMode.momentumBounce ? (u - e.minTranslate() > m && (u = e.minTranslate() + m),
                                t = e.minTranslate(),
                                f = !0,
                                o.allowMomentumBounce = !0) : u = e.minTranslate(),
                                r.loop && r.centeredSlides && (d = !0);
                            ...
                            0 !== e.velocity) {
                                if (c = l ? Math.abs((-u - e.translate) / e.velocity) : Math.abs((u - e.translate) / e.velocity),
                                r.freeMode.sticky) {
                            ...
                            r.freeMode.momentumBounce && f ? (e.updateProgress(t),
                            e.setTransition(c),
                            e.setTranslate(u),
                            e.transitionStart(!0, e.swipeDirection),
                            e.animating = !0,
                            E(a, () => {
                                e && !e.destroyed && o.allowMomentumBounce && (i("momentumBounce"),
                        ...
                        (!r.freeMode.momentum || d >= r.longSwipesMs) && (e.updateProgress(),
                        e.updateActiveIndex(),
                        e.updateSlidesClasses())
                    }
                }
